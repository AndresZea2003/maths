...
<!--                        <span> Escribe todas las maneras diferentes de ordenar horizontalmente los numeros 7, 8 y 9</span>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                                    <button @click="selectItem('7')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-blue-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">7</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('8')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-blue-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">8</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('9')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-blue-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">9</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
...
onMounted(() => {
    document.getElementById('caja101').innerHTML = '1'
    document.getElementById('caja102').innerHTML = '2'
    document.getElementById('caja103').innerHTML = '3'
    document.getElementById('caja104').innerHTML = '1'
    document.getElementById('caja105').innerHTML = '3'
    document.getElementById('caja106').innerHTML = '2'
    document.getElementById('caja107').innerHTML = '2'
    document.getElementById('caja108').innerHTML = '1'
    document.getElementById('caja109').innerHTML = '3'
    document.getElementById('caja110').innerHTML = '2'
    document.getElementById('caja111').innerHTML = '3'
    document.getElementById('caja112').innerHTML = '1'
    document.getElementById('caja113').innerHTML = '3'
    document.getElementById('caja114').innerHTML = '1'
    document.getElementById('caja115').innerHTML = '2'
    document.getElementById('caja116').innerHTML = '3'
    document.getElementById('caja117').innerHTML = '2'
    document.getElementById('caja118').innerHTML = '1'
});
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-stone-400 border-4 border-stone-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-12 gap-5">
                    <div id="fondoMati"
                         class="bg-orange-200 border-4 border-stone-600 rounded-md flex items-end justify-center col-span-2">
                        <div class="">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-stone-600 rounded-md pr-5 md:col-span-10 grid md:grid-cols-11 flex items-center">
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2 opacity-50">
                                            <button @click="selectItem('1')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">1</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('2')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">2</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('3')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">3</span>
                                                </div>
                                            </button>
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2">
                                            <button @click="selectItem('7')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">7</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('8')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">8</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('9')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">9</span>
                                                </div>
                                            </button>
