...
const check = () => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-check') &&
        ...
        document.getElementById('caja271').classList.contains(colorA) &&
        document.getElementById('caja272').classList.contains(colorA) &&
        document.getElementById('caja273').classList.contains(colorA) &&
        document.getElementById('caja274').classList.contains(colorA) &&
        document.getElementById('caja275').classList.contains(colorA) &&
        document.getElementById('caja276').classList.contains(colorA) &&
        document.getElementById('caja277').classList.contains(colorA) &&
        document.getElementById('caja278').classList.contains(colorA) &&
        document.getElementById('caja279').classList.contains(colorA) &&
                    ...
                    <div
                        ...
                        <div class="col-span-3 grid md:grid-cols-2 gap-x-5">
                            <div class="border-black border-4 flex items-center justify-center">
                                <div>
                                    <div class="p-6 border-white border-4">{{ null }}</div>
                                    <div class="p-6 border-white border-4">{{ null }}</div>
