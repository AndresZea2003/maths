...
<!--                                linea1-->
                                ...
                                <div class="grid grid-cols-3 border-black border-l-4 border-t-4 bg-green-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-4 bg-green-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-t-4 bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-x-4 border-b-4 bg-green-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-b-4 border-l-4 bg-green-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-r-4 border-y-4 bg-green-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-x-4 border-b-4 bg-stone-700">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-r-4 bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-l-4 bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-l-4 border-b-4 bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class="grid grid-cols-3 bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-r-4 border-b-4 bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                ...
                                <div class=" grid grid-cols-3 border-black border-b-4 border-r-4 bg-red-600">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
...
<!--                                linea1-->
                                ...
                                <div class=" grid grid-cols-3 border-black border-r-4 border-y-4">
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
                                    <div class="select-none p-2 hover:bg-blue-700">{{ null }}</div>
