...
<!--                        <span> Escribe todas las maneras diferentes de ordenar horizontalmente los colores Azul, Cafe y Amarillo</span>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('stone-700')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-stone-700 border-black border-4 p-9 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">{{ null }}</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
