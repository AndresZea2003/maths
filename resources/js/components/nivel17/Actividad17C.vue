                                    ...
                                    <div class="flex justify-center my-5 scale-100">
                                        <div class="grid md:grid-cols-12 flex justify-center items-center">
                                            <div v-for="i in 12" :key="i" :id="`num${i}`"
                                                 @click="add(`num${i}`)"
                                                 :class="['py-2', 'px-5', 'flex', 'justify-center', 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none', 'bg-gray-300'

                                             ]">
                                                <div class="flex justify-center font-MPlus text-xl">{{ this['num' + (i)] }}</div>
                                            </div>
                                        </div>
                                        <div class="grid md:grid-cols-9">
                                            <div v-for="i in 9" :key="i + 12" :id="`num${i + 12}`"
                                                 @click="add(`num${i + 12}`)"
                                                 :class="['py-2', 'px-5' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none', 'bg-gray-300'
                                             ]">
                                                <div class="flex justify-center font-MPlus text-xl">{{ this['num' + (i + 12)] }}</div>
                                            </div>
                                        </div>
                            ...
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectItem('A')"
                                        ...
                                        <div class="bg-red-300 border-black border-2 py-2 px-5 rounded-lg">
                                            <div class="flex justify-center font-MPlus text-2xl">A</div>
                                        </div>
                                    </button>
                                </div>
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectItem('B')"
                                            class="flex justify-center items-center ">
                                        <div class="bg-red-300 border-black border-2 py-2 px-5 rounded-lg">
                                            <div class="flex justify-center font-MPlus text-2xl">B</div>
                                        </div>
                                    </button>
                                </div>
