...
@section('main')
    <div class="min-h-full bg-space">
        <div class="container mx-auto">
            <div class="font-bold text-xl bg-gray-700 px-5 py-5 shadow-2xl text-gray-300 rounded-b-lg mx-5">Matematicas - Nivel 9
            </div>
        </div>
        <div class="container mx-auto mb-10 mt-5 rounded-md px-5 ">
            <div class="bg-rose-300 flex-col shadow-2xl rounded-md border-4 border-stone-600">
                <div class="flex justify-center">
                    <div class="font-bold text-2xl text-gray-600">Nivel Rosa</div>
                </div>
                <div class="gap-5 grid md:grid-cols-4 sm:grid-cols-1 mx-5">
                    <a href="{{route('normal.level-9.a')}}">
                        <div
