...
<!--        document.getElementById('caja2').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja3').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja4').classList.contains('bg-green-600') &&-->
<!--        document.getElementById('caja5').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja6').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja7').classList.contains('bg-green-600') &&-->
<!--        document.getElementById('caja8').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja9').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja10').classList.contains('bg-green-600') &&-->
<!--        document.getElementById('caja11').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja12').classList.contains('bg-blue-600')-->
<!--    ) {-->
...
<!--                <div class="mx-5 py-2">-->
<!--                    <div>-->
<!--                        <span class="font-bold">Actividad 6 -</span>-->
...
const paint = (id) => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-green-600') &&
        ...
        document.getElementById('caja11').classList.contains('bg-blue-600') &&
        document.getElementById('caja12').classList.contains('bg-blue-600') &&
        document.getElementById('caja13').classList.contains('bg-green-600') &&
        document.getElementById('caja14').classList.contains('bg-blue-600') &&
        document.getElementById('caja15').classList.contains('bg-blue-600') &&
        document.getElementById('caja16').classList.contains('bg-green-600') &&
        document.getElementById('caja17').classList.contains('bg-blue-600') &&
        document.getElementById('caja18').classList.contains('bg-blue-600')
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-600', 'bg-green-600', 'bg-pink-500', 'bg-yellow-400', 'bg-white');
                                    ...
                                    <div class="flex justify-center my-5">
                                        <div class="grid md:grid-cols-12">
                                            ...
                                            <div @click="paint('caja2')" id="caja2"
                                                 class="p-6 border-black border-2 bg-blue-600 cursor-cell">
                        ...
                        <div class="bg-orange-400 border-black border-4 px-5">
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectColor('blue-600')"
                                            class="rounded-md p-2 shadow-md bg-gray-300">
                                        <svg class="icon-blue" xmlns="http://www.w3.org/2000/svg" width="60"
