                                    ...
                                    <div>
                                        <div class="grid grid-cols-3">
                                            <div @click="error('caja1')" id="caja1"
                                                 class="p-8 bg-yellow-400 border-black border cursor-cell hover:bg-gray-400">
                                                {{ null }}
                                            ...
                                            <div @click="error('caja2')" id="caja2"
                                                 class="p-8 bg-blue-600 border-black border cursor-cell hover:bg-gray-400">{{
                                                    null
                                                }}
                                            ...
                                            <div @click="paint('caja3')" id="caja3"
                                                 class="p-8 border-black border cursor-cell hover:bg-gray-400">{{
                                                    null
                                                }}
                                            ...
                                            <div @click="error('caja5')" id="caja5"
                                                 class="p-8 bg-red-600 border-black border cursor-cell hover:bg-gray-400">{{
                                                    null
                                                }}
