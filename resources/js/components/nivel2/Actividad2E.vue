...
<!--        document.getElementById('caja4').classList.contains('bg-blue-600') &&-->
<!--        document.getElementById('caja5').classList.contains('bg-pink-500') &&-->
<!--        document.getElementById('caja6').classList.contains('bg-pink-500') &&-->
...
<!--        document.getElementById('caja12').classList.contains('bg-pink-500')-->
<!--    ) {-->
...
const paint = (id) => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-blue-600') &&
        ...
        document.getElementById('caja11').classList.contains('bg-pink-500') &&
        document.getElementById('caja12').classList.contains('bg-pink-500') &&
        document.getElementById('caja13').classList.contains('bg-blue-600') &&
        document.getElementById('caja14').classList.contains('bg-pink-500') &&
        document.getElementById('caja15').classList.contains('bg-pink-500') &&
        document.getElementById('caja16').classList.contains('bg-blue-600') &&
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-600', 'bg-red-600', 'bg-pink-500', 'bg-yellow-400', 'bg-white');
