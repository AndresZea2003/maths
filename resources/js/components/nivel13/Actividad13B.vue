...
<!--                        <span> Escribe todas las maneras diferentes de ordenar horizontalmente las letras D, E y F</span>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                                    <button @click="selectItem('D')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-green-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">D</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('E')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-green-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">E</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('F')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-green-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">F</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2">
                                            <button @click="selectItem('D')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">D</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('E')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">E</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('F')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">F</span>
                                                </div>
                                            </button>
