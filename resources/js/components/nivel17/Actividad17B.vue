...
const cuadrado = ref(`${props.asset_images}/cosas/cuadrado.svg`)
const triangulo = ref(`${props.asset_images}/cosas/triangulo.svg`)
const circulo = ref(`${props.asset_images}/cosas/circulo.svg`)
...
function initialAudio() {
    if (talk.value === false) {
        ...
        let sound = new Audio();
        sound.src = `${props.asset_audio}/voz1/nivel2/llegamos.m4a`;
        sound.play()
        setTimeout(function () {
            let sound = new Audio();
        ...
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/entiendes.m4a`;
            sound.play()
        }, 14500)
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/nivel2/continuacoloreando.m4a`;
            sound.play()
        }, 16000)
        widthMati.value = 160;
...
function showIndexSquare() {
    setTimeout(function () {
        document.getElementById('black').classList.remove('hidden', 'opacity-0')
        document.getElementById('black').classList.add('opacity-75')
        document.getElementById('fondo').classList.add('scale-110', 'z-40')
        document.getElementById('caja5').classList.remove('bg-white')
        document.getElementById('caja5').classList.add('bg-red-600')
    }, 8500)
    setTimeout(function () {

        document.getElementById('caja6').classList.remove('bg-white')
        document.getElementById('caja6').classList.add('bg-green-600')
    }, 10000)
    setTimeout(function () {
        document.getElementById('caja7').classList.remove('bg-white')
        document.getElementById('caja7').classList.add('bg-red-600')
    }, 11500)
    setTimeout(function () {
        document.getElementById('caja8').classList.remove('bg-white')
        document.getElementById('caja8').classList.add('bg-green-600')
    }, 13000)
    setTimeout(function () {
        document.getElementById('black').classList.add('hidden', 'opacity-0')
        document.getElementById('black').classList.remove('opacity-75')
        document.getElementById('fondo').classList.remove('scale-110', 'z-40')
    }, 16000)
}
...
const paint = (id) => {
    ...
    const colorErrors = [color1Error, color2Error, color3Error, color4Error, color5Error, color6Error, color7Error,
        ...
        color15Error, color16Error, color17Error, color18Error];
        ...
        if (box.classList.contains('bg-white')) {
            ...
            if (box.classList.contains(classToFind)) {
                ...
                if (!colorPainted.value) {
                    animateBg(`${props.asset_audio}/soapBubble.wav`, 1000, 'brush1', 'green-300');
                }
                ...
                if (!colorError.value) {
                    animateBg(`${props.asset_audio}/wood.wav`, 900, 'brush-fail', 'red-300');
                } else {
                    let sound = new Audio();
    ...
    function animateBg(soundSrc, time, animateClass, color) {
        document.getElementById('fondo').classList.remove('bg-orange-200');
        document.getElementById('fondo').classList.add(animateClass, `bg-${color}`, `border-${color}`);
        setTimeout(() => {
            document.getElementById('fondo').classList.remove(`bg-${color}`);
            document.getElementById('fondo').classList.add(animateClass, 'bg-orange-200');
            document.getElementById('fondo').classList.remove(animateClass);
        }, time);
    ...
    if (document.getElementById('caja1').classList.contains('bg-pink-500') &&
        ...
        document.getElementById('caja3').classList.contains('bg-green-600') &&
        document.getElementById('caja4').classList.contains('bg-pink-500') &&
        document.getElementById('caja5').classList.contains('bg-blue-900') &&
        document.getElementById('caja6').classList.contains('bg-green-600') &&
        ...
        document.getElementById('caja10').classList.contains('bg-pink-500') &&
        document.getElementById('caja11').classList.contains('bg-blue-900') &&
        document.getElementById('caja12').classList.contains('bg-green-600') &&
        document.getElementById('caja13').classList.contains('bg-pink-500') &&
        document.getElementById('caja14').classList.contains('bg-blue-900') &&
        document.getElementById('caja15').classList.contains('bg-green-600') &&
        document.getElementById('caja16').classList.contains('bg-pink-500') &&
        document.getElementById('caja17').classList.contains('bg-blue-900') &&
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-900', 'bg-pink-500', 'bg-green-600', 'bg-yellow-400', 'bg-white');
...
const win = () => {
    ...
    setTimeout(() => {
        document.getElementById('nave').classList.add('avanzar1');
...
const add = (num) => {
    ...
    if (num === 'num1') {
        if (content.value != null){
            ...
            num1.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num1.value = null
        ...
        if (content.value != null){
            ...
            num2.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num2.value = null
        ...
        if (content.value != null){
            ...
            num3.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num3.value = null
        ...
        if (content.value != null){
            ...
            num4.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num4.value = null
        ...
        if (content.value != null){
            ...
            num5.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num5.value = null
        ...
        if (content.value != null){
            ...
            num6.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num6.value = null
        ...
        if (content.value != null){
            ...
            num7.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num7.value = null
        ...
        if (content.value != null){
            ...
            num8.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num8.value = null
        ...
        if (content.value != null){
            ...
            num9.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num9.value = null
        ...
        if (content.value != null){
            ...
            num10.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num10.value = null
        ...
        if (content.value != null){
            ...
            num11.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num11.value = null
        ...
        if (content.value != null){
            ...
            num12.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num12.value = null
        ...
        if (content.value != null){
            ...
            num13.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num13.value = null
        ...
        if (content.value != null){
            ...
            num14.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num14.value = null
        ...
        if (content.value != null){
            ...
            num15.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num15.value = null
        ...
        if (content.value != null){
            ...
            num16.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num16.value = null
        ...
        if (content.value != null){
            ...
            num17.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num17.value = null
        ...
        if (content.value != null){
            ...
            num18.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num18.value = null
        ...
        if (content.value != null){
            // document.getElementById('num19').classList.remove('p-7')
            // document.getElementById('num19').classList.add('p-4')
            num19.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num19.value = null
            // document.getElementById('num19').classList.remove('py-3')
            // document.getElementById('num19').classList.remove('px-5')
            // // document.getElementById('num19').classList.add('p-7')
        }
    } else if (num === 'num20') {
        if (content.value != null){
            // document.getElementById('num20').classList.remove('p-7')
            // document.getElementById('num20').classList.add('p-4')
            num20.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num20.value = null
            // document.getElementById('num20').classList.remove('py-3')
            // document.getElementById('num20').classList.remove('px-5')
            // // document.getElementById('num20').classList.add('p-7')
        }
    } else if (num === 'num21') {
        if (content.value != null){
            // document.getElementById('num21').classList.remove('p-7')
            // document.getElementById('num21').classList.add('p-4')
            num21.value = `${props.asset_images}/cosas/${content.value}.svg`
        }else {
            num21.value = null
            // document.getElementById('num21').classList.remove('py-3')
            // document.getElementById('num21').classList.remove('px-5')
            // document.getElementById('num21').classList.add('p-2')
        }
    }
}
...
<template>
    <div id="black"
         class="hidden fixed top-0 left-0 w-full h-full bg-black opacity-0 transition-opacity duration-500"></div>
    <div id="loader"
            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center mr-auto">
                        <span class="text-white mx-3 font-bold text-yellow-500">Actividad 2</span>
                    </div>
            ...
            <div class="bg-orange-300 border-4 border-orange-400 flex-col pb-2 rounded-md shadow-2xl">
                <div class="mx-5 py-2 flex justify-between">
                    <div>
                        ...
                        <span> Completa la secuencia de colores</span>
                    </div>
                </div>
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    <div id="fondoMati"
                         class="bg-orange-200 border-4 border-orange-400 rounded-md flex items-end justify-center">
                        <div class="">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-orange-400 rounded-md pb-5 px-5 md:col-span-4 grid md:grid-cols-3 flex">
                        ...
                        <div class="col-span-3">
                            <div class="flex justify-center mt-5 gap-5">
                                ...
                                <div id="barras" class="grid grid-cols-12 gap-x-1 bg-gray-600 h-5 rounded-full mt-3">
                                    <div id="b-1" class="bg-gray-400 rounded-l-full h-5"></div>
                                    <div id="b-2" class="bg-gray-400 h-5"></div>
                                    ...
                                    <div class="bg-gray-400 h-5"></div>
                                    <div class="bg-gray-400 h-5"></div>
                                    <div class="bg-gray-400 rounded-r-full h-5"></div>
                        ...
                        <div class="col-span-3">
                            ...
                            <div id="fondo"
                                 class="bg-orange-200 border-4 border-orange-400 flex justify-center p-5 duration-300">
                                <div class="flex-col">
                                    <div class="flex justify-center grid grid-cols-2">
                                        <div class="font-bold text-2xl text-center">OBSERVA</div>
                                        <div class="font-bold text-2xl text-center">COLOREA</div>
                                    </div>
                                    <div class="flex justify-center my-5 scale-100">
                                        <div class="grid md:grid-cols-12 flex justify-center items-center">
                                            <div v-for="i in 12" :key="i" :id="`num${i}`"
                                                 @click="add(`num${i}`)"
                                                 :class="['p-2' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none', 'bg-gray-300'

                                             ]">
                                                <img :src=" this['num' + (i)]" width="20">
                                            </div>
                                        </div>
                                        <div class="grid md:grid-cols-9">
                                            <div v-for="i in 9" :key="i + 12" :id="`num${i + 12}`"
                                                 @click="add(`num${i + 12}`)"
                                                 :class="['p-2' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none', 'bg-gray-300'
                                             ]">
                                                <img :src=" this['num' + (i + 12)]" width="20">
                                            </div>
                                        </div>
                                        <!--                                        <div class="grid md:grid-cols-12">-->
                                        <!--                                            <div @click="paint('caja1')" id="caja1"-->
                                        <!--                                                 class="p-6 border-black border-2 bg-pink-500 cursor-cell">-->
                                        <!--                                                <div v-if="color1Error">-->
                                        <!--                                                    <svg fill="black" xmlns="http://www.w3.org/2000/svg" width="24"-->
                                        <!--                                                         height="24"-->
                                        <!--                                                         viewBox="0 0 24 24">-->
                                        <!--                                                        <path-->
                                        ...
                                        <!--                                                 class="p-6 border-black border-2 bg-blue-900 cursor-cell">-->
                                        <!--                                                <div v-if="color2Error">-->
                                        <!--                                                    <svg fill="black" xmlns="http://www.w3.org/2000/svg" width="24"-->
                                        <!--                                                         height="24"-->
                                        <!--                                                         viewBox="0 0 24 24">-->
                                        <!--                                                        <path-->
                                        ...
                                        <!--                                                 class="p-6 border-black border-2 bg-green-600 cursor-cell">-->
                                        <!--                                                <div v-if="color3Error">-->
                                        <!--                                                    <svg fill="black" xmlns="http://www.w3.org/2000/svg" width="24"-->
                                        <!--                                                         height="24"-->
                                        <!--                                                         viewBox="0 0 24 24">-->
                                        <!--                                                        <path-->
                                        ...
                                        <!--                                                 class="p-6 border-black border-2 bg-white cursor-cell">-->
                                        <!--                                                <div v-if="color7Error">-->
                                        <!--                                                    <svg fill="black" xmlns="http://www.w3.org/2000/svg" width="24"-->
                                        <!--                                                         height="24"-->
                                        <!--                                                         viewBox="0 0 24 24">-->
                                        <!--                                                        <path-->
                                        ...
                                        <!--                                                 class=" flex justify-center items-center border-black border-2 bg-white cursor-cell">-->
                                        <!--                                                <div v-if="color18Error">-->
                                        <!--                                                    <svg fill="black" xmlns="http://www.w3.org/2000/svg" width="24"-->
                                        <!--                                                         height="24"-->
                                        <!--                                                         viewBox="0 0 24 24">-->
                                        <!--                                                        <path-->
                    ...
                    <div>
                        <div class="bg-orange-400 border-black border-4 px-5">
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectItem('cuadrado')"
                                            class="flex justify-center items-center ">
                                        <div class="bg-red-300 border-black border-2 p-5 rounded-lg">
                                            <img :src="cuadrado" width="30" alt="">
                                        </div>
                                    </button>
                                </div>

                                <div class="flex justify-center">
                                    <button @click="selectItem('triangulo')"
                                                    class="flex justify-center items-center ">
                                                <div class="bg-red-300 border-black border-2 p-5 rounded-lg">
                                                    <img :src="triangulo" width="30" alt="">
                                                </div>
                                            </button>
                                </div>

                                <div class="flex justify-center col-span-2">
                                    <button @click="selectItem('circulo')"
                                                    class="flex justify-center items-center ">
                                                <div class="bg-red-300 border-black border-2 p-5 rounded-lg">
                                                    <img :src="circulo" width="30" alt="">
                                                </div>
                                            </button>
                                </div>
                                ...
                                <div v-if="ShowEraser === true" @click="selectItem(null)"
                                ...
                                <button v-else @click="selectItem(null)"
