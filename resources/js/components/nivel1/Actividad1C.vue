...
const paint = (id) => {
    ...
    // Borrador
    const colorErrors = [color1Error, color2Error, color3Error, color4Error];
...
const win = () => {
    let sound = new Audio();
    sound.src = `${props.asset_audio}/voz1/win/excelente1.m4a`;
    sound.play();
                    ...
                    <div id="board"
                        ...
                        <div :class="`${selectFig1} ml-5`">
                            ...
                            <div id="vista" class="flex justify-center mt-5 rotate-45 scale-75 duration-300">
                                <div class="flex-col grid gap-5 rotate-90">
                        ...
                        <div class="flex justify-center h-full pt-16">
                            ...
                            <div v-if="winLevel === true" class="">
                                ...
                                <span
                                    class="font-MPlus text-2xl bg-green-400 p-2 rounded-lg border-4 border-green-500 animate-pulse">Excelente!</span>
                                    ...
                                    <div v-else>
                                        <div class="grid grid-cols-2">
                                            <div @click="paint('caja1')" id="caja1"
                                                ...
                                                {{ null }}
                                                <div v-if="color1Error === true" class="flex justify-center rotate-180">
                                                    <span
                                                        class="text-2xl font-bold animate-pulse text-center select-none rotate-45">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja2')" id="caja2"
                                                ...
                                                <div v-if="color2Error === true" class="flex justify-center rotate-180">
                                                    <span
                                                        class="text-2xl font-bold animate-pulse text-center select-none rotate-45">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja3')" id="caja3"
                                                ...
                                                <div v-if="color3Error === true" class="flex justify-center rotate-180">
                                                    <span
                                                        class="text-2xl font-bold animate-pulse text-center select-none rotate-45">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja4')" id="caja4"
                                                ...
                                                <div v-if="color4Error === true" class="flex justify-center rotate-180">
                                                    <span
                                                        class="text-2xl font-bold animate-pulse text-center select-none rotate-45">Error</span>
                                                </div>
                                            </div>
