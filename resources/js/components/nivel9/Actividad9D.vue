...
let specialNumbers = [
    10, 20, 28, 30, 37, 38, 40, 46, 47, 48, 50, 55, 56, 57, 58,
    60, 64, 65, 66, 67, 68, 70, 74, 75, 76, 77, 78, 80, 84, 85,
    86, 87, 88, 90, 91, 94, 95, 96, 97, 98, 100
]

let paintNumbers = [
    2, 3, 12, 22, 32, 42, 52, 62, 72, 82, 92, 9, 19, 29, 39, 49,
    59, 69, 79, 89, 99, 13, 23, 33, 43, 53, 63, 73, 83, 93
]
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-10 gap-x-2">
                                        <div v-for="i in 100" :key="i" :id="`caja${i}`" @click="boxClicked(i)"
                                             ...
                                             { 'bg-red-500' : specialNumbers.includes(i)},
