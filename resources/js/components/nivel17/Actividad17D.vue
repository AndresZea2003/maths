        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-orange-300 border-4 border-orange-400 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-orange-400 rounded-md pb-5 px-5 md:col-span-3 grid md:grid-cols-3 flex items-center">


                        <div class="col-span-3">
                            <div class="flex justify-center mt-5 gap-5">
                                <div>
                                    <img :src="`${props.asset_images}/planetas/tierra.svg`" width="100" alt="">
                                </div>
                                <div id="barras" class="grid grid-cols-10 gap-x-1 bg-gray-600 h-10 rounded-full mt-3">
                                    <div id="b-1" class="bg-gray-400 rounded-l-full h-10"></div>
                                    <div id="b-2" class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 h-10"></div>
                                    <div class="bg-gray-400 rounded-r-full h-10"></div>
                                ...
                                <div>
                                    <img :src="`${props.asset_images}/planetas/rojo.svg`" width="100" alt="">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="grid-cols-2 grid">
                                    <div class="col-span-2 mx-1 flex justify-center mt-5">
                                        <div class="bg-pink-200 rounded-md px-2 flex py-1">
                                    ...
                                    <div class="flex justify-center mt-5">
                                        <button @click="selectColor('red-600')"
                                            ...
                                            <svg class="icon-red1" xmlns="http://www.w3.org/2000/svg" width="60"
                                                 height="60"
                                                 viewBox="0 0 24 24">
                                                <path
                                ...
                                <div>
                                    <div class="col-span-2 mx-1 flex justify-center mt-5">
                                        <div class="bg-pink-200 rounded-md px-2 py-4 flex">
                                            <ArrowDownIcon class="w-5"/>
                    ...
                    <div class="col-span-6 bg-white border-4 border-orange-400 rounded-md py-5 px-5">
                        <div>
                            <div id="fondo"
                                ...
                                <div class="flex-col">
                                    ...
                                    <div class="flex justify-center grid grid-cols-4 my-5 scale-105">
                                        <div class="grid md:grid-cols-12">
                                            <div v-for="i in 12" :key="i" :id="`caja${i}`"
                                                 @click="paint(`caja${i}`)"
                                                 :class="['px-3', 'py-4' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none',
                                                     { ['bg-' + props.color_1] : i === 1 || i === 2 || i === 8 || i === 9 || i === 10 },
                                                     { ['bg-' + props.color_2] : i === 3 || i === 4|| i === 5|| i === 6|| i === 7|| i === 8 || i === 11 || i === 12}
                                        ...
                                        <div class="grid md:grid-cols-12">
                                            <div v-for="i in 12" :key="i + 12" :id="`caja${i + 12}`"
                                                 @click="paint(`caja${i + 12}`)"
                                                 :class="['px-3', 'py-4' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none',
                                                     { ['bg-' + props.color_1] : i + 12 === 17 || i + 12 === 18 },
                                                     { ['bg-' + props.color_2] : i + 12 === 13 || i + 12 === 14 || i + 12 === 15 ||  i + 12 === 16 || i + 12 === 19 || i + 12 === 20 || i + 12 === 21 || i + 12 === 22 || i + 12 === 23 || i + 12 === 24}
                                             ]">
                                                {{ null }}
                                            </div>
                                        </div>
                                        <div class="grid md:grid-cols-12">
                                            <div v-for="i in 12" :key="i + 24" :id="`caja${i + 24}`"
                                                 @click="paint(`caja${i + 24}`)"
                                                 :class="['px-3', 'py-4' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none', 'bg-white'
                                             ]">
                                                {{ null }}
                                            </div>
                                        </div>
