...
let numMuestra1 = ref(1)
let numMuestra2 = ref(2)
let numMuestra3 = ref(3)
let numMuestra4 = ref(2)
let numMuestra5 = ref(3)
let numMuestra6 = ref(1)
let numMuestra7 = ref(3)
let numMuestra8 = ref(1)
let numMuestra9 = ref(2)

let numMuestra10 = ref(1)
let numMuestra11 = ref(3)
let numMuestra12 = ref(2)
let numMuestra13 = ref(3)
let numMuestra14 = ref(2)
let numMuestra15 = ref(1)
let numMuestra16 = ref(2)
let numMuestra17 = ref(1)
let numMuestra18 = ref(3)
                                            ...
                                            <div class="flex justify-center">
                                                <div class="grid grid-cols-3">
                                                    <div v-for="i in 9" :key="i" :id="`caja${i + 100}`"
                                                        ...
                                                        <div class="flex justify-center font-MPlus text-2xl">{{ this['numMuestra' + i] }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="flex justify-center">
                                                <div class="grid grid-cols-3">
                                                    <div v-for="i in 9" :key="i" :id="`caja${i + 100}`"
                                                        ...
                                                        <div class="flex justify-center font-MPlus text-2xl">{{ this['numMuestra' + (i + 9)] }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div :class="`${selectFig3} mr-5 pb-5 duration-300 col-span-4`">
                            ...
                            <div id="actividad" class="flex justify-center mt-5">
                                <div class="flex-col">
                                    <div>
                                        <div class="grid grid-cols-3">
                                            <div @click="add('num1')" id="caja1"
                                                 class="py-4 px-6 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <span class="font-MPlus text-3xl flex justify-center">{{ num1 }}</span>
                                            ...
                                            <div @click="error('caja2')" id="caja2"
                                                 class="py-4 px-6 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <span class="font-MPlus text-3xl flex justify-center">1</span>
                                                <div v-if="color2Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num3')" id="caja3"
                                                 class="py-4 px-6 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <span class="font-MPlus text-3xl flex justify-center">{{ num3 }}</span>
                                            ...
                                            <div @click="error('caja5')" id="caja5"
                                                 class="py-4 px-6 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <span class="font-MPlus text-3xl flex justify-center">2</span>
                                                <div v-if="color5Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num6')" id="caja6"
                                                 class="py-4 px-6 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <span class="font-MPlus text-3xl flex justify-center">{{ num6 }}</span>
                                                <div v-if="color6Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num7')" id="caja7"
                                                 class="py-4 px-6 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <span class="font-MPlus text-3xl flex justify-center">{{ num7 }}</span>
                                            ...
                                            <div @click="error('caja8')" id="caja8"
                                                 class="py-4 px-6 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <span class="font-MPlus text-3xl flex justify-center">3</span>
