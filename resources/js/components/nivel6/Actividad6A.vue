                    ...
                    <div id="board"
                        ...
                        <div class="col-span-3">
                            <div class="flex justify-center m-5 gap-5">
                                <div>
                                    <img :src="`${props.asset_images}/planetas/saturno.svg`" class="scale-150" width="50" alt="">
                                </div>
                                ...
                                <div>
                                    <img :src="`${props.asset_images}/planetas/jupiter.svg`" class="" width="50" alt="">
                                </div>
                            </div>
                        ...
                        <div :class="`${selectFig1} ml-5`">
                            ...
                            <div id="vista" class="flex justify-center mt-5 duration-300">
                                <div class="flex-col grid gap-5">
                                    <div class="grid grid-cols-5 rotate-45 mt-5">
                                        <div v-for="i in 25" :key="i" :id="`muestra${i}`"
                                             :class="['p-4' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none',
                                                     { 'bg-blue-600' : i === 1 || i === 2 || i === 3 || i === 4|| i === 5|| i === 6 || i === 10 || i === 11 || i === 15 || i === 16 || i === 20 ||
                                                     i === 21 || i === 22 || i === 23 || i === 24 || i === 25
                                                       },
                                                     { 'bg-red-600' : i === 7 || i === 8|| i === 9|| i === 12|| i === 14 || i === 17 || i === 18|| i === 19},
                                                     { 'bg-gray-800' : i === 13}
                        ...
                        <div :class="`${selectFig3} mr-5 pb-5 duration-300`">
                            ...
                            <div id="actividad" class="flex justify-center mt-5">
                                <div class="flex-col">
                                    <div>
                                        <div class="grid grid-cols-5 rotate-45 mt-5">
                                            <div v-for="i in 25" :key="i" :id="`caja${i}`"
                                             @click="paint(`caja${i}`)"
                                             :class="['p-4' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none'
                                             ]">
                                            {{ null }}
                            ...
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectColor('red-600')"
                                            class="rounded-md p-2 shadow-md bg-gray-300">
                                        <svg class="hover:opacity-60" fill="red" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                             viewBox="0 0 24 24">
                                            <path
                                                d="M0 21.398c5.504.456 3.533-5.392 8.626-5.445l2.206 1.841c.549 6.645-7.579 8.127-10.832 3.604zm16.878-8.538c1.713-2.687 7.016-11.698 7.016-11.698.423-.747-.515-1.528-1.17-.976 0 0-7.887 6.857-10.213 9.03-1.838 1.719-1.846 2.504-2.441 5.336l2.016 1.681c2.67-1.098 3.439-1.248 4.792-3.373z"/>
                                        </svg>
