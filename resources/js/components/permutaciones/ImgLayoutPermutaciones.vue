                            ...
                            <div id="vista" class="items-center justify-center p-2 mt-5 duration-300">
                                <div class="flex justify-center">
                                    <div class="grid grid-cols-3 gap-y-5 gap-x-1">
                                        ...
                                        <!--                                            {{ items[i - 1].value }}-->
                                        <!--                                        </div>-->
                                        <button v-for="i in 18" :key="i" :id="`caja${i}`"
                                                @click="paintString(`caja${i}`, i - 1)"
                                                class="border-black border-2 flex justify-center items-center h-12 w-12 duration-300">
                                            <img :src="items[i - 1].value" width="30">
                                        </button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-5 mt-5">
                                            <div class="flex justify-center">
                                                <button @click="selectItem(props.item_1)"
                                                    ...
                                                    <div class="bg-gray-300 p-4 shadow-md rounded-lg">
                                                        <img :src="props.item_1" width="40" alt="">
                                                    </div>
                                                </button>
                                            </div>
                                            ...
                                            <div class="flex justify-center">
                                                <button @click="selectItem(props.item_2)"
                                                        class="flex justify-center items-center ">
                                                    <div class="bg-gray-300 p-4 shadow-md rounded-lg">
                                                        <img :src="props.item_2" width="40" alt="">
                                                    </div>
                                                </button>
                                            </div>
                                            ...
                                            <div class="flex justify-center">
                                                <button @click="selectItem(props.item_3)"
                                                        class="flex justify-center items-center ">
                                                    <div class="bg-gray-300 p-4 shadow-md rounded-lg">
                                                        <img :src="props.item_3" width="40" alt="">
                                                    </div>
                                                </button>
                                            </div>
                                            ...
                                            <div class="flex justify-center">
                                                <button @click="selectItem(null)"
                                                        class="flex justify-center items-center ">
                                                    <div class="bg-gray-300 p-4 shadow-md rounded-lg">
                                                        <img :src="eraser" alt="borrador" width="40">
                                                    </div>
                                                </button>
                                            </div>

                                            <div v-if="content === null" id="muestra"
                                                 class="border-2 border-black py-7 px-5 mt-5 bg-white col-span-2 shadow-2xl shadow-blue-900 flex justify-center font-bold text-5xl">
                                                <span>{{ null }}</span>
                                            </div>

                                            <div v-else id="muestra"
                                                 class="border-2 border-black py-2 mt-5 bg-white col-span-2 shadow-2xl shadow-blue-900 flex justify-center font-bold text-5xl">
                                                <img :src="content" width="40">
                                            </div>
                                        </div>
