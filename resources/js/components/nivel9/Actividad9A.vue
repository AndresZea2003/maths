...
<!--            document.getElementById('fondoMati').classList.add('bg-red-300')-->
<!--        }-->
<!--    } else {-->
...
<!--                                    <div class="bg-red-200 rounded-md px-2 flex">-->
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-red-400 border-4 border-red-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-12 gap-5">
                    <div id="fondoMati"
                         class="bg-orange-200 border-4 border-red-600 rounded-md flex items-end justify-center col-span-2">
                        <div class="">
                    ...
                    <div id="board"
                        ...
                        <div :class="`${selectFig1} ml-5 col-span-5`">
                            <div class="flex justify-between">
                                ...
                                <div class="flex justify-center">
                                    <img class="scale-50 transition-500 duration-300" id="eye" :src="eye" width="100"
                                         alt="">
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-10 gap-x-2">
                                        ...
                                        <div @click="error('caja10')" id="caja10"
                                             class="p-5 bg-red-500  border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja66')" id="caja66"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja67')" id="caja67"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja68')" id="caja68"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="paint('caja69')" id="caja69"
                                        ...
                                        <div @click="error('caja70')" id="caja70"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>

                                        <div @click="error('caja71')" id="caja71"
                                             class="p-5 bg-white border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja72')" id="caja72"
                                             class="p-5 bg-white border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja73')" id="caja73"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja74')" id="caja74"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="paint('caja75')" id="caja75"
                                        ...
                                        <div @click="error('caja76')" id="caja76"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja77')" id="caja77"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja78')" id="caja78"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="paint('caja79')" id="caja79"
                                        ...
                                        <div @click="error('caja80')" id="caja80"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>

                                        <div @click="error('caja81')" id="caja81"
                                             class="p-5 bg-white border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja82')" id="caja82"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja83')" id="caja83"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja84')" id="caja84"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="paint('caja85')" id="caja85"
                                        ...
                                        <div @click="error('caja86')" id="caja86"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja87')" id="caja87"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja88')" id="caja88"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="paint('caja89')" id="caja89"
                                        ...
                                        <div @click="error('caja90')" id="caja90"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>

                                        <div @click="error('caja91')" id="caja91"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja92')" id="caja92"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja93')" id="caja93"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja94')" id="caja94"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="paint('caja95')" id="caja95"
                                        ...
                                        <div @click="error('caja96')" id="caja96"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja97')" id="caja97"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="error('caja98')" id="caja98"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        <div @click="paint('caja99')" id="caja99"
                                        ...
                                        <div @click="error('caja100')" id="caja100"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
