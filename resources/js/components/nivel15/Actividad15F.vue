...
const paint = (id) => {
    ...
    document.getElementById(id).classList.remove('bg-fuchsia-600')
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-orange-300 border-4 border-orange-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-orange-600 rounded-md pb-5 pr-5 md:col-span-4 grid md:grid-cols-3 flex items-center">
                                                ...
                                                <div class="grid grid-cols-3">
                                                    <div v-for="i in 9" :key="i" :id="`caja${i + 109}`"
                                                         :class="['p-5', 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400',
                                                                                 { 'bg-blue-600' : i + 109 === 112 || i + 109 === 113 || i + 109 === 117},
                                                                                 { 'bg-fuchsia-600': i + 109 === 110 || i + 109 === 114 || i + 109 === 118},
                                                                                 { 'bg-gray-700': i + 109 === 111 || i + 109 === 115 || i + 109 === 116}
                                                                                 ]">
                                                        {{ null }}
                                                    </div>
                                                </div>
                                    ...
                                    <div>
                                        <div class="grid grid-cols-3">
                                            ...
                                            <div @click="error('caja2')" id="caja2"
                                                 class="p-8 bg-green-600 border-black border cursor-cell hover:bg-gray-400">{{
                                                    null
                                                }}
                                            ...
                                            <div @click="error('caja3')" id="caja3"
                                                 class="p-8 bg-fuchsia-600 border-black border cursor-cell hover:bg-gray-400">
                                                {{
                                                    null
                                                }}
                    ...
                    <div>
                        <div class="bg-orange-300 border-black border-4 px-5">
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectColor('fuchsia-600')"
                                            class="rounded-md p-2 shadow-md bg-gray-300">
                                        <svg class="icon-fuchsia" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                             viewBox="0 0 24 24">
                                            <path
                                                d="M0 21.398c5.504.456 3.533-5.392 8.626-5.445l2.206 1.841c.549 6.645-7.579 8.127-10.832 3.604zm16.878-8.538c1.713-2.687 7.016-11.698 7.016-11.698.423-.747-.515-1.528-1.17-.976 0 0-7.887 6.857-10.213 9.03-1.838 1.719-1.846 2.504-2.441 5.336l2.016 1.681c2.67-1.098 3.439-1.248 4.792-3.373z"/>
                                        </svg>
