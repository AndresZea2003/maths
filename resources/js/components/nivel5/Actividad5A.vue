...
function initialAudio() {
    if (talk.value === false) {
        ...
        let sound = new Audio();
        sound.src = `${props.asset_audio}/voz1/nivel5/muy-bien-llegamos.m4a`;
        sound.play()
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/nivel5/para-completar.m4a`;
            sound.play()
            setTimeout(function () {
                ...
                document.getElementById('caja13').classList.remove('bg-white')
                document.getElementById('caja18').classList.remove('bg-white')
                document.getElementById('caja23').classList.remove('bg-white')
                document.getElementById('caja28').classList.remove('bg-white')
                document.getElementById('caja3').classList.add('bg-yellow-400')
                document.getElementById('caja8').classList.add('bg-yellow-400')
                document.getElementById('caja13').classList.add('bg-yellow-400')
                document.getElementById('caja18').classList.add('bg-yellow-400')
                document.getElementById('caja23').classList.add('bg-yellow-400')
                document.getElementById('caja28').classList.add('bg-yellow-400')
            }, 3000)
            setTimeout(function () {
                document.getElementById('caja3').classList.remove('bg-yellow-400')
                document.getElementById('caja8').classList.remove('bg-yellow-400')
                document.getElementById('caja13').classList.remove('bg-yellow-400')
                document.getElementById('caja18').classList.remove('bg-yellow-400')
                document.getElementById('caja23').classList.remove('bg-yellow-400')
                document.getElementById('caja28').classList.remove('bg-yellow-400')
        ...
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/nivel5/recuerda-que.m4a`;
            sound.play()
        }, 10000)
        setTimeout(function () {
            let sound = new Audio();
        ...
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/numbers/cuatro.m4a`;
            sound.play()
        }, 17000)
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/numbers/cinco.m4a`;
            sound.play()
        }, 18000)
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/nivel5/sigue-la.m4a`;
            sound.play()
...
function showIndexSquare() {
    setTimeout(function () {
        document.getElementById('caja110').classList.add('scale-110');
        document.getElementById('caja110').classList.remove('bg-pink-500');
        document.getElementById('caja110').classList.add('bg-yellow-400');
    }, 14000);
    setTimeout(function () {
        document.getElementById('caja110').classList.remove('scale-110');
        document.getElementById('caja110').classList.add('bg-pink-500');
        document.getElementById('caja110').classList.remove('bg-yellow-400');

        document.getElementById('caja106').classList.add('scale-110');
        document.getElementById('caja106').classList.remove('bg-pink-500');
        document.getElementById('caja106').classList.add('bg-yellow-400');

        document.getElementById('caja111').classList.add('scale-110');
        document.getElementById('caja111').classList.remove('bg-pink-500');
        document.getElementById('caja111').classList.add('bg-yellow-400');
    }, 15000);
    setTimeout(function () {
        document.getElementById('caja106').classList.remove('scale-110');
        document.getElementById('caja106').classList.add('bg-pink-500');
        document.getElementById('caja106').classList.remove('bg-yellow-400');

        document.getElementById('caja111').classList.remove('scale-110');
        document.getElementById('caja111').classList.add('bg-pink-500');
        document.getElementById('caja111').classList.remove('bg-yellow-400');

        document.getElementById('caja112').classList.add('scale-110');
        document.getElementById('caja112').classList.remove('bg-pink-500');
        document.getElementById('caja112').classList.add('bg-yellow-400');

        document.getElementById('caja107').classList.add('scale-110');
        document.getElementById('caja107').classList.remove('bg-pink-500');
        document.getElementById('caja107').classList.add('bg-yellow-400');

        document.getElementById('caja103').classList.add('scale-110');
        document.getElementById('caja103').classList.remove('bg-pink-500');
        document.getElementById('caja103').classList.add('bg-yellow-400');
    }, 16000);
    setTimeout(function () {
        document.getElementById('caja112').classList.remove('scale-110');
        document.getElementById('caja112').classList.add('bg-pink-500');
        document.getElementById('caja112').classList.remove('bg-yellow-400');

        document.getElementById('caja107').classList.remove('scale-110');
        document.getElementById('caja107').classList.add('bg-pink-500');
        document.getElementById('caja107').classList.remove('bg-yellow-400');

        document.getElementById('caja103').classList.remove('scale-110');
        document.getElementById('caja103').classList.add('bg-pink-500');
        document.getElementById('caja103').classList.remove('bg-yellow-400');

        document.getElementById('caja113').classList.add('scale-110');
        document.getElementById('caja113').classList.remove('bg-pink-500');
        document.getElementById('caja113').classList.add('bg-yellow-400');

        document.getElementById('caja108').classList.add('scale-110');
        document.getElementById('caja108').classList.remove('bg-pink-500');
        document.getElementById('caja108').classList.add('bg-yellow-400');

        document.getElementById('caja104').classList.add('scale-110');
        document.getElementById('caja104').classList.remove('bg-pink-500');
        document.getElementById('caja104').classList.add('bg-yellow-400');

        document.getElementById('caja101').classList.add('scale-110');
        document.getElementById('caja101').classList.remove('bg-pink-500');
        document.getElementById('caja101').classList.add('bg-yellow-400');
    }, 17000);
    setTimeout(function () {
        document.getElementById('caja113').classList.remove('scale-110');
        document.getElementById('caja113').classList.add('bg-pink-500');
        document.getElementById('caja113').classList.remove('bg-yellow-400');

        document.getElementById('caja108').classList.remove('scale-110');
        document.getElementById('caja108').classList.add('bg-pink-500');
        document.getElementById('caja108').classList.remove('bg-yellow-400');

        document.getElementById('caja104').classList.remove('scale-110');
        document.getElementById('caja104').classList.add('bg-pink-500');
        document.getElementById('caja104').classList.remove('bg-yellow-400');

        document.getElementById('caja101').classList.remove('scale-110');
        document.getElementById('caja101').classList.add('bg-pink-500');
        document.getElementById('caja101').classList.remove('bg-yellow-400');

        document.getElementById('caja114').classList.add('scale-110');
        document.getElementById('caja114').classList.remove('bg-pink-500');
        document.getElementById('caja114').classList.add('bg-yellow-400');

        document.getElementById('caja109').classList.add('scale-110');
        document.getElementById('caja109').classList.remove('bg-pink-500');
        document.getElementById('caja109').classList.add('bg-yellow-400');

        document.getElementById('caja105').classList.add('scale-110');
        document.getElementById('caja105').classList.remove('bg-pink-500');
        document.getElementById('caja105').classList.add('bg-yellow-400');

        document.getElementById('caja102').classList.add('scale-110');
        document.getElementById('caja102').classList.remove('bg-pink-500');
        document.getElementById('caja102').classList.add('bg-yellow-400');

        document.getElementById('caja100').classList.add('scale-110');
        document.getElementById('caja100').classList.remove('bg-pink-500');
        document.getElementById('caja100').classList.add('bg-yellow-400');
    }, 18000);
    setTimeout(function () {
        document.getElementById('caja114').classList.remove('scale-110');
        document.getElementById('caja114').classList.add('bg-pink-500');
        document.getElementById('caja114').classList.remove('bg-yellow-400');

        document.getElementById('caja109').classList.remove('scale-110');
        document.getElementById('caja109').classList.add('bg-pink-500');
        document.getElementById('caja109').classList.remove('bg-yellow-400');

        document.getElementById('caja105').classList.remove('scale-110');
        document.getElementById('caja105').classList.add('bg-pink-500');
        document.getElementById('caja105').classList.remove('bg-yellow-400');

        document.getElementById('caja102').classList.remove('scale-110');
        document.getElementById('caja102').classList.add('bg-pink-500');
        document.getElementById('caja102').classList.remove('bg-yellow-400');

        document.getElementById('caja100').classList.remove('scale-110');
        document.getElementById('caja100').classList.add('bg-pink-500');
        document.getElementById('caja100').classList.remove('bg-yellow-400');
    }, 19000);
...
function helpFigures() {
    ...
    document.getElementById('vista').classList.add('scale-100');
    ...
    setTimeout(function () {
        ...
        document.getElementById('vista').classList.remove('scale-100');
    ...
    setTimeout(function () {
        selectFig3.value = 'rounded-md animate-pulse scale-105';
    }, 2000);
}
...
const paint = (id) => {
    ...
    // Borrador
    const colorErrors = [color1Error, color2Error, color3Error, color4Error, color5Error, color6Error];
    ...
    if (document.getElementById('caja3').classList.contains('bg-white') &&
        ...
        document.getElementById('caja18').classList.contains('bg-pink-500') &&
        document.getElementById('caja23').classList.contains('bg-pink-500') &&
        document.getElementById('caja28').classList.contains('bg-pink-500')
    ) {
        win()
        let sound = new Audio();
...
const selectColor = (bg) => {
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-pink-500', 'bg-white');
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-red-400 border-4 border-red-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    <div id="fondoMati"
                         class="bg-orange-200 border-4 border-red-600 rounded-md flex items-end justify-center">
                        <div class="">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-red-600 rounded-md pb-5 pr-5 md:col-span-4 grid md:grid-cols-3 flex items-center">


                        <div class="col-span-3">
                            <div class="flex justify-center m-5 gap-5">
                                <div>
                                    <img :src="`${props.asset_images}/planetas/venus.svg`" width="50" alt="">
                                </div>
                                ...
                                <div>
                                    <img class="scale-150" :src="`${props.asset_images}/planetas/saturno.svg`"
                                         width="50" alt="">
                                </div>
                            </div>
                        ...
                        <div :class="`${selectFig1} ml-5`">
                            ...
                            <div id="vista" class="border-gray-400 border-4 flex items-center justify-center duration-300">
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-5 gap-x-2">
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        ...
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div id="caja100" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div id="caja101" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja102" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div id="caja103" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja104" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja105" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div class="p-6 border-black border-2 duration-300">{{ null }}</div>
                                        <div id="caja106" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja107" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja108" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja109" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja110" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja111" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja112" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja113" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                        <div id="caja114" class="p-6 bg-pink-500 border-black border-2 duration-300">
                                            {{ null }}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="fig3" :class="`${selectFig3} mr-5 pb-5 duration-300`">
                            ...
                            <div id="actividad" class="border-gray-400 border-4 flex items-center justify-center duration-300">
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-5 gap-x-2">
                                        <div @click="error('caja1')" id="caja1"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        ...
                                        <div @click="paint('caja3')" id="caja3"
                                             class="border-dashed p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        ...
                                        <div @click="error('caja6')" id="caja6"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja7')" id="caja7"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        ...
                                        <div @click="error('caja10')" id="caja10"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja11')" id="caja11"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja12')" id="caja12"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        <div @click="paint('caja13')" id="caja13"
                                             class="p-6 duration-300 bg-white border-dashed border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja14')" id="caja14"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja15')" id="caja15"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja16')" id="caja16"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja17')" id="caja17"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        ...
                                        <div @click="error('caja19')" id="caja19"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja20')" id="caja20"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja21')" id="caja21"
                                             class="p-6 duration-300 bg-white border-black border-2 cursor-cell hover:bg-gray-400">{{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja22')" id="caja22"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        ...
                                        <div @click="paint('caja23')" id="caja23"
                                             class="p-6 duration-300 border-dashed border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja24')" id="caja24"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja25')" id="caja25"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja26')" id="caja26"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja27')" id="caja27"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        ...
                                        <div @click="error('caja29')" id="caja29"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                                        </div>
                                        <div @click="error('caja30')" id="caja30"
                                             class="p-6 duration-300 bg-pink-500 border-black border-2 cursor-cell hover:bg-gray-400">
                                            {{
                                                null
                                            }}
                    ...
                    <div>
                        <div class="bg-red-500 border-black border-4 px-5">
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center col-span-2">
                                    <button @click="selectColor('pink-500')"
                                            class="rounded-md p-2 shadow-md bg-gray-300">
                                        <svg class="icon-pink" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                             viewBox="0 0 24 24">
                                            <path
                                                d="M0 21.398c5.504.456 3.533-5.392 8.626-5.445l2.206 1.841c.549 6.645-7.579 8.127-10.832 3.604zm16.878-8.538c1.713-2.687 7.016-11.698 7.016-11.698.423-.747-.515-1.528-1.17-.976 0 0-7.887 6.857-10.213 9.03-1.838 1.719-1.846 2.504-2.441 5.336l2.016 1.681c2.67-1.098 3.439-1.248 4.792-3.373z"/>
                                        </svg>
