...
<layout-sudoku
        ...
        item_1="{{ asset('images/animales/perro.svg') }}"
        item_2="{{ asset('images/animales/conejo.svg') }}"
        item_3="{{ asset('images/animales/gato.svg') }}"
        color_1=""
        color_2=""
        color_3=""
        icon_1="icon-blue"
        icon_2="icon-yellow"
        icon_3="icon-red1"
        sound_item_1="{{asset('audio/voz1/animals/the/ElPerro.m4a')}}"
        sound_item_2="{{asset('audio/voz1/animals/the/ElConejo.m4a')}}"
        sound_item_3="{{asset('audio/voz1/animals/the/ElGato.m4a')}}"
