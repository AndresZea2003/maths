...
const check = () => {
    ...
    if (document.getElementById('caja444').classList.contains('bg-pink-500')) {
        ...
        colorG = 'bg-yellow-400'
    } else if (document.getElementById('caja444').classList.contains('bg-red-500')) {
        colorG = 'bg-red-500'
    }

    if (document.getElementById('caja445').classList.contains('bg-pink-500')) {
        colorB = 'bg-pink-500'
    } else if (document.getElementById('caja445').classList.contains('bg-yellow-400')) {
        colorB = 'bg-yellow-400'
    } else if (document.getElementById('caja445').classList.contains('bg-red-500')) {
        colorB = 'bg-red-500'
    }

    if (document.getElementById('caja446').classList.contains('bg-pink-500')) {
        colorE = 'bg-pink-500'
    } else if (document.getElementById('caja446').classList.contains('bg-yellow-400')) {
        colorE = 'bg-yellow-400'
    } else if (document.getElementById('caja446').classList.contains('bg-red-500')) {
        colorE = 'bg-red-500'
    }

    if (document.getElementById('caja447').classList.contains('bg-pink-500')) {
        colorH = 'bg-pink-500'
    } else if (document.getElementById('caja447').classList.contains('bg-yellow-400')) {
        colorH = 'bg-yellow-400'
    } else if (document.getElementById('caja447').classList.contains('bg-red-500')) {
        colorH = 'bg-red-500'
    }

    if (document.getElementById('caja448').classList.contains('bg-pink-500')) {
        colorC = 'bg-pink-500'
    } else if (document.getElementById('caja448').classList.contains('bg-yellow-400')) {
        colorC = 'bg-yellow-400'
    } else if (document.getElementById('caja448').classList.contains('bg-red-500')) {
        colorC = 'bg-red-500'
    }

    if (document.getElementById('caja449').classList.contains('bg-pink-500')) {
        colorF = 'bg-pink-500'
    } else if (document.getElementById('caja449').classList.contains('bg-yellow-400')) {
        colorF = 'bg-yellow-400'
    } else if (document.getElementById('caja449').classList.contains('bg-red-500')) {
        colorF = 'bg-red-500'
    }

    if (document.getElementById('caja450').classList.contains('bg-pink-500')) {
        colorI = 'bg-pink-500'
    } else if (document.getElementById('caja450').classList.contains('bg-yellow-400')) {
        colorI = 'bg-yellow-400'
    } else if (document.getElementById('caja450').classList.contains('bg-red-500')) {
        colorI = 'bg-red-500'
    }
    ...
    if (document.getElementById('caja1').classList.contains('bg-check') &&
        ...
        document.getElementById('caja145').classList.contains(colorA) &&
        document.getElementById('caja146').classList.contains(colorA) &&
        document.getElementById('caja147').classList.contains(colorA) &&
        document.getElementById('caja148').classList.contains(colorA) &&
        document.getElementById('caja149').classList.contains(colorA) &&
        document.getElementById('caja150').classList.contains(colorA) &&
        document.getElementById('caja151').classList.contains(colorA) &&
        document.getElementById('caja152').classList.contains(colorA) &&
        document.getElementById('caja153').classList.contains(colorA) &&
        document.getElementById('caja154').classList.contains(colorB) &&
        document.getElementById('caja155').classList.contains(colorB) &&
        document.getElementById('caja156').classList.contains(colorB) &&
        document.getElementById('caja157').classList.contains(colorB) &&
        document.getElementById('caja158').classList.contains(colorB) &&
        document.getElementById('caja159').classList.contains(colorB) &&
        document.getElementById('caja160').classList.contains(colorB) &&
        document.getElementById('caja161').classList.contains(colorB) &&
        document.getElementById('caja162').classList.contains(colorB) &&
        document.getElementById('caja163').classList.contains(colorC) &&
        document.getElementById('caja164').classList.contains(colorC) &&
        document.getElementById('caja165').classList.contains(colorC) &&
        document.getElementById('caja166').classList.contains(colorC) &&
        document.getElementById('caja167').classList.contains(colorC) &&
        document.getElementById('caja168').classList.contains(colorC) &&
        document.getElementById('caja169').classList.contains(colorC) &&
        document.getElementById('caja170').classList.contains(colorC) &&
        document.getElementById('caja171').classList.contains(colorC) &&
        ...
        document.getElementById('caja208').classList.contains(colorD) &&
        document.getElementById('caja209').classList.contains(colorD) &&
        document.getElementById('caja210').classList.contains(colorD) &&
        document.getElementById('caja211').classList.contains(colorD) &&
        document.getElementById('caja212').classList.contains(colorD) &&
        document.getElementById('caja213').classList.contains(colorD) &&
        document.getElementById('caja214').classList.contains(colorD) &&
        document.getElementById('caja215').classList.contains(colorD) &&
        document.getElementById('caja216').classList.contains(colorD) &&
        document.getElementById('caja217').classList.contains(colorE) &&
        document.getElementById('caja218').classList.contains(colorE) &&
        document.getElementById('caja219').classList.contains(colorE) &&
        document.getElementById('caja220').classList.contains(colorE) &&
        document.getElementById('caja221').classList.contains(colorE) &&
        document.getElementById('caja222').classList.contains(colorE) &&
        document.getElementById('caja223').classList.contains(colorE) &&
        document.getElementById('caja224').classList.contains(colorE) &&
        document.getElementById('caja225').classList.contains(colorE) &&
        document.getElementById('caja226').classList.contains(colorF) &&
        document.getElementById('caja227').classList.contains(colorF) &&
        document.getElementById('caja228').classList.contains(colorF) &&
        document.getElementById('caja229').classList.contains(colorF) &&
        document.getElementById('caja230').classList.contains(colorF) &&
        document.getElementById('caja231').classList.contains(colorF) &&
        document.getElementById('caja232').classList.contains(colorF) &&
        document.getElementById('caja233').classList.contains(colorF) &&
        document.getElementById('caja234').classList.contains(colorF) &&
        ...
        document.getElementById('caja271').classList.contains(colorG) &&
        document.getElementById('caja272').classList.contains(colorG) &&
        document.getElementById('caja273').classList.contains(colorG) &&
        document.getElementById('caja274').classList.contains(colorG) &&
        document.getElementById('caja275').classList.contains(colorG) &&
        document.getElementById('caja276').classList.contains(colorG) &&
        document.getElementById('caja277').classList.contains(colorG) &&
        document.getElementById('caja278').classList.contains(colorG) &&
        document.getElementById('caja279').classList.contains(colorG) &&
        document.getElementById('caja280').classList.contains(colorH) &&
        document.getElementById('caja281').classList.contains(colorH) &&
        document.getElementById('caja282').classList.contains(colorH) &&
        document.getElementById('caja283').classList.contains(colorH) &&
        document.getElementById('caja284').classList.contains(colorH) &&
        document.getElementById('caja285').classList.contains(colorH) &&
        document.getElementById('caja286').classList.contains(colorH) &&
        document.getElementById('caja287').classList.contains(colorH) &&
        document.getElementById('caja288').classList.contains(colorH) &&
        document.getElementById('caja289').classList.contains(colorI) &&
        document.getElementById('caja290').classList.contains(colorI) &&
        document.getElementById('caja291').classList.contains(colorI) &&
        document.getElementById('caja292').classList.contains(colorI) &&
        document.getElementById('caja293').classList.contains(colorI) &&
        document.getElementById('caja294').classList.contains(colorI) &&
        document.getElementById('caja295').classList.contains(colorI) &&
        document.getElementById('caja296').classList.contains(colorI) &&
        document.getElementById('caja297').classList.contains(colorI) &&
    ...
    <div class="min-h-full bg-space" @mousedown="clickPaint()" @mouseup="clickPaint()">
        ...
        <div class="container mx-auto mb-10 rounded-md px-5">
            <div class="bg-violet-300 border-4 border-violet-600 flex-col pb-2 rounded-md shadow-2xl">
                <div class="mx-5 py-2">
                    <div>
                        <span class="font-bold">Actividad 10 -</span>
                    ...
                    <div
                        ...
                        <div class="col-span-3 grid md:grid-cols-2 gap-x-5">
                            <div class="border-black border-4 flex items-center justify-center">
                                ...
                                <div>
                                    <div @click="paintClick('caja445')" class="p-6 border-black border-4 rounded"
                                         id="caja445">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja446')" class="p-6 border-black border-4 rounded"
                                         id="caja446">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja447')" class="p-6 border-black border-4 rounded"
                                         id="caja447">{{ null }}
                                    </div>
                                </div>
                                <div>
                                    <div @click="paintClick('caja448')" class="p-6 border-black border-4 rounded"
                                         id="caja448">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja449')" class="p-6 border-black border-4 rounded"
                                         id="caja449">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja450')" class="p-6 border-black border-4 rounded"
                                         id="caja450">{{ null }}
                                    </div>
                                </div>
                            </div>
