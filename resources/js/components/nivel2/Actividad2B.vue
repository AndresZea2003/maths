...
const paint = (id) => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-pink-500') &&
        ...
        document.getElementById('caja18').classList.contains('bg-blue-900')
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-900', 'bg-pink-500', 'bg-white');
                                    ...
                                    <div class="flex justify-center my-5">
                                        <div class="grid md:grid-cols-12">
                                            ...
                                            <div @click="paint('caja2')" id="caja2"
                                                 class="p-6 border-black border-2 bg-orange-500 cursor-cell">
