...
const props = defineProps({
    ...
    audio_item_1: {type: String, required: true},
    audio_item_2: {type: String, required: true},
    audio_item_3: {type: String, required: true},
    audio_item_extra: {type: String, required: true},
    ...
    initial_audio_1: {type: String, required: true},
    initial_audio_2: {type: String, required: true},
    initial_audio_3: {type: String, required: true},
})
...
function initialAudio() {
    if (talk.value === false) {
        ...
        let sound = new Audio();
        sound.src = props.initial_audio_1;
        sound.play()
        ...
        setTimeout(function () {
            let sound = new Audio();
            sound.src = props.initial_audio_2;
            sound.play()
        }, 8000)

        setTimeout(function () {
            let sound = new Audio();
            sound.src = props.initial_audio_3;
            sound.play()
        }, 12000)
...
const audioItem1 = () => {
    let sound = new Audio();
    sound.src = props.audio_item_1;
    sound.play()
}

const audioItem2 = () => {
    let sound = new Audio();
    sound.src = props.audio_item_2;
    sound.play()
}

const audioItem3 = () => {
    let sound = new Audio();
    sound.src = props.audio_item_3;
    sound.play()
}

const audioItemExtra = () => {
    let sound = new Audio();
    sound.src = props.audio_item_extra;
    sound.play()
}
...
function showIndexSquare() {
    ...
    setTimeout(function () {
        ...
        contentIndexSquare.value = props.item_1
    }, 3000);
    setTimeout(function () {
        audioItem2()
        indexSquare.value = `border-black border-2 h-24 w-24 bg-gray-300 flex justify-center items-center`;
        contentIndexSquare.value = props.item_2
    }, 4500);
    setTimeout(function () {
        audioItemExtra()
        indexSquare.value = `border-black border-2 h-24 w-24 bg-gray-300 flex justify-center items-center`;
        contentIndexSquare.value = props.item_3
    }, 6000);
    setTimeout(function () {
        indexSquare.value = '';
...
<template>
    ...
    <div class="min-h-full bg-space">
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div :class="`${props.bg_color_activity} border-4 ${props.border_color_activity} flex-col pb-2 rounded-md shadow-2xl`">
                        ...
                        <div class="">
                            ...
                            <div v-if="indexSquareFig === 'colors'" class="flex justify-center items-center mb-16">
                                <div :class="`${indexSquare}`">
                                    <span class="font-bold text-6xl">{{ contentIndexSquare }}</span>
                                </div>
                            </div>
                            ...
                            <div id="vista" class="items-center justify-center p-2 mt-5 duration-300">
                                <div class="flex justify-center">
                                    <div class="grid grid-cols-3 gap-y-5 gap-x-1">
                                        <div id="error1"
                                             class="absolute -translate-x-[60px] translate-y-[4px] opacity-0 duration-300">
                                            <div class="rounded-full bg-red-infinite">
                                                <svg width="40" fill="red" viewBox="0 0 64 64" version="1.1"
                                                    ...
                                                    <g id="SVGRepo_iconCarrier"> <rect id="Icons" x="-704" y="-64"
                                                        ...
                                                        <g id="Icons1" serif:id="Icons"> <g id="Strike"> </g>
                                                            ...
                                                            <g id="user"> </g>
                                                            <g id="coffee-bean"> </g>
                                                            <g id="coffee-beans"> <g id="coffee-bean1"
                                                                                     serif:id="coffee-bean"> </g> </g>
                                                            <g id="coffee-bean-filled"> </g>
                                                            <g id="coffee-beans-filled"> <g id="coffee-bean2"
                                                                                            serif:id="coffee-bean"> </g> </g>
                                                            <g id="clipboard"> </g>
                                        ...
                                        <div id="error2"
                                             class="absolute -translate-x-[60px] translate-y-[75px] opacity-0 duration-300">
                                            <div class="rounded-full bg-red-infinite">
                                                <svg width="40" fill="red" viewBox="0 0 64 64" version="1.1"
                                                     xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
                                        ...
                                        <div id="error3"
                                             class="absolute -translate-x-[60px] translate-y-[140px] opacity-0 duration-300">
                                            <div class="rounded-full bg-red-infinite">
                                                <svg width="40" fill="red" viewBox="0 0 64 64" version="1.1"
                                                     xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
                                        ...
                                        <div id="error4"
                                             class="absolute -translate-x-[60px] translate-y-[210px] opacity-0 duration-300">
                                            <div class="rounded-full bg-red-infinite">
                                                <svg width="40" fill="red" viewBox="0 0 64 64" version="1.1"
                                                     xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
                                        ...
                                        <div id="error5"
                                             class="absolute -translate-x-[60px] translate-y-[280px] opacity-0 duration-300">
                                            <div class="rounded-full bg-red-infinite">
                                                <svg width="40" fill="red" viewBox="0 0 64 64" version="1.1"
                                                     xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
                                        ...
                                        <div id="error6"
                                             class="absolute -translate-x-[60px] translate-y-[350px] opacity-0 duration-300">
                                            <div class="rounded-full bg-red-infinite">
                                                <svg width="40" fill="red" viewBox="0 0 64 64" version="1.1"
                                                     xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
                                ...
                                <!--                                                &lt;!&ndash;                                                <div v-for="i in 18" :key="i + 100" :id="`caja${i + 100}`"&ndash;&gt;-->
                                <!--                                                &lt;!&ndash;                                                     :class="['p-6', 'border-black', 'border-2', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300',&ndash;&gt;-->
                                <!--                                                &lt;!&ndash;                                             { 'bg-red-600' : i + 100 ===  || i + 100 === 6 || i + 100 === 7 || i + 100 === 10 || i + 100 === 15 || i + 100 === 17},&ndash;&gt;-->
                                <!--                                                &lt;!&ndash;                                             { 'bg-blue-600': i + 100 === 1 || i + 100 === 4 || i + 100 === 9 || i + 100 ===  || i + 100 ===  || i + 100 === 18},&ndash;&gt;-->
                                <!--                                                &lt;!&ndash;                                             { 'bg-green-500': i + 100 === 3 || i + 100 ===  || i + 100 ===  || i + 100 === 12 || i + 100 === 13 || i + 100 === 16}&ndash;&gt;-->
                                <!--                                                &lt;!&ndash;                                             ]">&ndash;&gt;-->
                                <!--                                                &lt;!&ndash;                                                    {{ null }}&ndash;&gt;-->
                                <!--                                                &lt;!&ndash;                                                </div>&ndash;&gt;-->
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="flex justify-center items-center">
                                                <span id="observa"
                                                      class="font-MPlus text-SM duration-300">{{ props.palette_text }}</span>
                                </div>
