...
const check = () => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-check') &&
        ...
        document.getElementById('caja217').classList.contains(color2) &&
        document.getElementById('caja218').classList.contains(color2) &&
        document.getElementById('caja219').classList.contains(color2) &&
        document.getElementById('caja220').classList.contains(color2) &&
        document.getElementById('caja221').classList.contains(color2) &&
        document.getElementById('caja222').classList.contains(color2) &&
        document.getElementById('caja223').classList.contains(color2) &&
        document.getElementById('caja224').classList.contains(color2) &&
        document.getElementById('caja225').classList.contains(color2) &&
                        ...
                        <div class="col-span-3 grid md:grid-cols-2 gap-x-5">
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-7">
                                    ...
                                    <div class="grid grid-cols-3 grid-rows-2 border-black border-black border-r-4">
                                    ...
                                    <div class="grid grid-cols-3 grid-rows-2 border-black border-black border-l-4">
