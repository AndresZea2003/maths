                    ...
                    <div
                        ...
                        <div class="col-span-3 grid md:grid-cols-2 gap-x-5">
                            <div class="border-black border-4 flex items-center justify-center">
                                <div>
                                    <div @click="paintClick('caja442')" class="p-6 border-white border-4 rounded"
                                         id="caja442">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja443')" class="p-6 border-black border-4 rounded"
                                         id="caja443">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja444')" class="p-6 border-white border-4 rounded"
                                         id="caja444">{{ null }}
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    <div @click="paintClick('caja448')" class="p-6 border-white border-4 rounded"
                                         id="caja448">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja449')" class="p-6 border-black border-4 rounded"
                                         id="caja449">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja450')" class="p-6 border-white border-4 rounded"
                                         id="caja450">{{ null }}
                                    </div>
                                </div>
                            </div>
