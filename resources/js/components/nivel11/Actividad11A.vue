...
<!--        }-->
<!--    } else {-->
<!--        document.getElementById('fig1').classList.remove('text-yellow-400')-->
...
<!--                                             class="p-5 bg-yellow-400 border-black border-2 cursor-cell hover:bg-gray-400">{{-->
<!--                                                null-->
<!--                                            }}-->
<!--                                        </div>-->
...
let color21Error = ref(false);
let color22Error = ref(false);
let color23Error = ref(false);
let color24Error = ref(false);
let color25Error = ref(false);
let color26Error = ref(false);
let color27Error = ref(false);
let color28Error = ref(false);
let color29Error = ref(false);
let color30Error = ref(false);
...
let colorPainted21 = ref(false);
let colorPainted22 = ref(false);
let colorPainted23 = ref(false);
let colorPainted24 = ref(false);
let colorPainted25 = ref(false);
let colorPainted26 = ref(false);
let colorPainted27 = ref(false);
let colorPainted28 = ref(false);
let colorPainted29 = ref(false);
let colorPainted30 = ref(false);
...
const paint = (id) => {
    ...
    const colorErrors = [color1Error, color2Error, color3Error, color4Error, color5Error, color6Error, color7Error,
        ...
        color15Error, color16Error, color17Error, color18Error, color19Error, color20Error, color21Error, color22Error, color23Error, color24Error,
        color25Error, color26Error, color27Error, color28Error, color29Error, color30Error];
    ...
    const boxes = {
        ...
        'caja4': {
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted21,
            colorError: color21Error
        },
        'caja14': {
            num: 14,
            classToFind: 'bg-white',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted22,
            colorError: color22Error
        },
        'caja24': {
            num: 24,
            classToFind: 'bg-white',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted23,
            colorError: color23Error
        },
        'caja34': {
            num: 34,
            classToFind: 'bg-white',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted24,
            colorError: color24Error
        },
        'caja44': {
            num: 44,
            classToFind: 'bg-white',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted25,
            colorError: color25Error
        },
        'caja54': {
            num: 54,
            classToFind: 'bg-white',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted26,
            colorError: color26Error
        },
        'caja64': {
            num: 64,
            classToFind: 'bg-yellow-400',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted27,
            colorError: color27Error
        },
        'caja74': {
            num: 74,
            classToFind: 'bg-yellow-400',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted28,
            colorError: color28Error
        },
        'caja84': {
            num: 84,
            classToFind: 'bg-yellow-400',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted29,
            colorError: color29Error
        },
        'caja94': {
            num: 94,
            classToFind: 'bg-yellow-400',
            ...
            // classToRemove: 'py-8',
            // classToRemove2: 'px-5',
            colorPainted: colorPainted30,
            colorError: color30Error
        },
    };
...
const selectColor = (bg) => {
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-yellow-400', 'bg-white');
...
const boxClicked = (boxNumber) => {
    if (
        paintNumbers.includes(boxNumber)
    ) {
...
<template>
    ...
    <div class="min-h-full bg-space">
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-yellow-200 border-4 border-red-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-12 gap-5">
                    ...
                    <div id="board"
                            ...
                            <div id="vista" class="border-gray-400 border-4 flex items-center justify-center">
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-10 gap-x-1">
                                        <div class="p-5 bg-yellow-400 border-black border">{{ null }}</div>
                        ...
                        <div class="flex justify-center h-full pt-16">
                            ...
                            <div v-if="winLevel === true" class="">
                                ...
                                <span
                                    class="font-MPlus text-2xl bg-red-400 p-2 rounded-lg border-4 border-yellow-400 animate-pulse">Felicidades!</span>
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-10 gap-x-2">
                                        <div v-for="i in 100" :key="i" :id="`caja${i}`" @click="boxClicked(i)"
                                             ...
                                             { 'bg-yellow-400' : specialNumbers.includes(i)},
                                             { 'border-dashed' : paintNumbers.includes(i) }]">
                                            {{ null }}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div class="bg-yellow-400 border-black border-4">
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div v-if="ShowEraser === true" @click="selectColor('white')"
                                    ...
                                    <div
                                        class="w-3 h-3 bg-red-400 rounded-full absolute top-0 right-0 -mt-1 -mr-1"></div>
                                    <div
                                        class="w-3 h-3 bg-red-400 rounded-full absolute top-0 right-0 -mt-1 -mr-1 animate-ping"></div>
                                    <button class="eraser">
                                        <div class="relative">
