...
<!--        document.getElementById('caja2').classList.contains('bg-pink-500') &&-->
...
<!--        document.getElementById('caja8').classList.contains('bg-pink-500') &&-->
...
<!--                                <button-->
<!--                                    class="bg-red-300 px-2 py-1 rounded-md border-red-800 border-2 flex items-center hover:text-white hover:bg-pink-500 hover:scale-90 duration-300">-->
...
const paint = (id) => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-pink-500') &&
        ...
        document.getElementById('caja14').classList.contains('bg-pink-500') &&
        ...
        document.getElementById('caja17').classList.contains('bg-pink-500') &&
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-pink-500', 'bg-yellow-400', 'bg-blue-900', 'bg-green-600', 'bg-white');
