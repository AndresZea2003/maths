                ...
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    ...
                    <div id="board"
                        ...
                        <div class="col-span-3 mt-5">
                            ...
                            <div class="bg-blue-600 grid grid-cols-2 gap-5">
                                <div class="bg-white border-4 rounded-md border-violet-600 flex-col">
                                    <div class="border-b-2 border-black border-dashed flex justify-center">
                                        <div class="p-6 border-4 border-black my-16">{{ null }}</div>
                                    </div>
                                    <div class="flex justify-center bg-violet-100">
                                        <span class="font-MPlus text-2xl py-5">1 X 1</span>
                                    </div>
                                </div>
                                <div class="bg-white border-4 rounded-md border-violet-600 flex-col">
                                    <div class="border-b-2 border-black border-dashed flex justify-center">
