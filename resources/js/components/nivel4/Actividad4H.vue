...
const check = () => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-check') &&
        ...
        document.getElementById('caja217').classList.contains('bg-check') &&
        document.getElementById('caja218').classList.contains('bg-check') &&
        document.getElementById('caja219').classList.contains('bg-check') &&
        document.getElementById('caja220').classList.contains('bg-check') &&
        document.getElementById('caja221').classList.contains('bg-check') &&
        document.getElementById('caja222').classList.contains('bg-check') &&
        document.getElementById('caja223').classList.contains('bg-check') &&
        document.getElementById('caja224').classList.contains('bg-check') &&
        document.getElementById('caja225').classList.contains('bg-check') &&
    ...
    <div class="min-h-full bg-space" @mousedown="clickPaint()" @mouseup="clickPaint()">
        ...
        <div class="container mx-auto mb-10 rounded-md px-5">
            <div class="bg-violet-300 border-4 border-violet-600 flex-col pb-2 rounded-md shadow-2xl">
                <div class="mx-5 py-2">
                    <div>
                        <span class="font-bold">Actividad 8 -</span>
