...
const check = () => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-check') &&
        ...
        document.getElementById('caja208').classList.contains('bg-check') &&
        document.getElementById('caja209').classList.contains('bg-check') &&
        document.getElementById('caja210').classList.contains('bg-check') &&
        document.getElementById('caja211').classList.contains('bg-check') &&
        document.getElementById('caja212').classList.contains('bg-check') &&
        document.getElementById('caja213').classList.contains('bg-check') &&
        document.getElementById('caja214').classList.contains('bg-check') &&
        document.getElementById('caja215').classList.contains('bg-check') &&
        document.getElementById('caja216').classList.contains('bg-check') &&
        ...
        document.getElementById('caja226').classList.contains('bg-check') &&
        document.getElementById('caja227').classList.contains('bg-check') &&
        document.getElementById('caja228').classList.contains('bg-check') &&
        document.getElementById('caja229').classList.contains('bg-check') &&
        document.getElementById('caja230').classList.contains('bg-check') &&
        document.getElementById('caja231').classList.contains('bg-check') &&
        document.getElementById('caja232').classList.contains('bg-check') &&
        document.getElementById('caja233').classList.contains('bg-check') &&
        document.getElementById('caja234').classList.contains('bg-check') &&
                        ...
                        <div class="col-span-3 grid md:grid-cols-2 gap-x-5">
                            <div class="border-black border-4 flex items-center justify-center">
                                <div>
                                    ...
                                    <div @click="paintClick('caja443')" class="p-6 border-white border-4 rounded"
                                         id="caja443">{{ null }}
                                    </div>
                                ...
                                <div>
                                    <div @click="paintClick('caja445')" class="p-6 border-white border-4 rounded"
                                         id="caja445">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja446')" class="p-6 border-black border-4 rounded"
                                         id="caja446">{{ null }}
                                    </div>
                                    <div @click="paintClick('caja447')" class="p-6 border-white border-4 rounded"
                                         id="caja447">{{ null }}
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div @click="paintClick('caja449')" class="p-6 border-white border-4 rounded"
                                         id="caja449">{{ null }}
                                    </div>
