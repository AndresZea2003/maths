...
<!--                        <span> Escribe todas las maneras diferentes de ordenar horizontalmente el Sol, Corazon y la Hoja</span>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                                    <button @click="selectItem('sol')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-orange-300 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <img :src="sol" width="50" alt="">-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('corazon')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-orange-300 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <img :src="corazon" width="50" alt="">-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('hoja')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-orange-300 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <img :src="hoja" width="50" alt="">-->
<!--                                        </div>-->
<!--                                    </button>-->
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2">
                                            <button @click="selectItem('sol')"
                                                    class="flex justify-center items-center ">
                                                <div class="bg-orange-300 border-black border-2 py-3 px-5 rounded-lg">
                                                    <img :src="sol" width="30" alt="">
                                                </div>
                                            </button>
                                            <button @click="selectItem('corazon')"
                                                    class="flex justify-center items-center ">
                                                <div class="bg-orange-300 border-black border-2 py-3 px-5 rounded-lg">
                                                    <img :src="corazon" width="30" alt="">
                                                </div>
                                            </button>
                                            <button @click="selectItem('hoja')"
                                                    class="flex justify-center items-center ">
                                                <div class="bg-orange-300 border-black border-2 py-3 px-5 rounded-lg">
                                                    <img :src="hoja" width="30" alt="">
                                                </div>
                                            </button>
