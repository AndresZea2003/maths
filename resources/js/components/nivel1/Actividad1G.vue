...
function helpFigures() {
    selectFig1.value = 'rounded-md animate-pulse bg-gray-200';
    ...
    document.getElementById('vista').classList.add('scale-50');
    ...
    setTimeout(function () {
        ...
        document.getElementById('vista').classList.remove('scale-50');
    ...
    setTimeout(function () {
        selectFig3.value = 'rounded-md animate-pulse scale-75 bg-gray-200';
    }, 2000);
}
...
const paint = (id) => {
    ...
    // Borrador
    const colorErrors = [color1Error, color2Error, color3Error, color4Error, color5Error, color6Error, color7Error, color8Error, color9Error, color10Error, color11Error, color12Error, color13Error, color14Error, color15Error, color16Error];
...
const selectColor = (bg) => {
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-yellow-400', 'bg-red-600', 'bg-green-600', 'bg-blue-600' ,'bg-white');
...
const win = () => {
    let sound = new Audio();
    sound.src = `${props.asset_audio}/voz1/win/brillante1.m4a`;
    sound.play();
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-circles-blue border-4 border-blue-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-blue-600 rounded-md pb-5 pr-5 md:col-span-4 grid md:grid-cols-3 flex items-center s">
                        ...
                        <div class="col-span-3">
                            <div class="flex justify-center m-5 gap-5">
                                ...
                                <div id="barras" class="grid grid-cols-7 gap-x-1 bg-gray-600 h-5 rounded-full mt-3">
                                    ...
                                    <div class="bg-green-400 w-20 h-5"></div>
                                    <div class="bg-green-400 w-20 h-5"></div>
                                    <div id="b-1" class="bg-gray-400 w-20 rounded-r-full h-5"></div>
                        ...
                        <div :class="`${selectFig1} ml-5`">
                            ...
                            <div id="vista" class="flex justify-center mt-5 rotate-45 scale-75 duration-300 ">
                                <div class="flex-col grid gap-5">
                                    <div class="grid grid-cols-4">
                                        <div class="p-8 border-black border-2 bg-red-600">{{ null }}</div>
                                        <div class="p-8 border-black border-2 bg-yellow-400">{{ null }}</div>
                                        <div class="p-8 border-black border-2 bg-red-600">{{ null }}</div>
                                        <div class="p-8 border-black border-2 bg-yellow-400">{{ null }}</div>
                                        <div class="p-8 border-black border-2 bg-yellow-400">{{ null }}</div>
                                        <div class="p-8 border-black border-2 bg-red-600">{{ null }}</div>
                        ...
                        <div class="flex justify-center h-full pt-16">
                            ...
                            <div v-if="winLevel === true" class="">
                                ...
                                <span
                                    class="font-MPlus text-2xl bg-green-400 p-2 rounded-lg border-4 border-green-500 animate-pulse">Brillante!</span>
                        ...
                        <div :class="`${selectFig3} mr-5 pb-5 duration-300`">
                            ...
                            <div id="actividad" class="flex justify-center mt-5 rotate-45 scale-75">
                                <div class="flex-col">
                                    <div>
                                        <div class="grid grid-cols-4">
                                            <div @click="paint('caja1')" id="caja1"
                                                ...
                                                {{ null }}
                                                <div v-if="color1Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                            ...
                                            <div @click="paint('caja2')" id="caja2"
                                                ...
                                                <div v-if="color2Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja3')" id="caja3"
                                                ...
                                                <div v-if="color3Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja4')" id="caja4"
                                                ...
                                                <div v-if="color4Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja5')" id="caja5"
                                                ...
                                                <div v-if="color5Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja6')" id="caja6"
                                                ...
                                                <div v-if="color6Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja7')" id="caja7"
                                                ...
                                                <div v-if="color7Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja8')" id="caja8"
                                                ...
                                                <div v-if="color8Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja9')" id="caja9"
                                                ...
                                                <div v-if="color9Error === true" class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="paint('caja10')" id="caja10"
                                                 class="p-8 border-black border-2 cursor-cell hover:bg-gray-400">
                                                {{ null }}
                                                <div v-if="color10Error === true"
                                                     class="flex justify-center -rotate-45">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
