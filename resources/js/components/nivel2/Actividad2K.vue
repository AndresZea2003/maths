...
<!--        document.getElementById('caja9').classList.contains('bg-yellow-400') &&-->
<!--        document.getElementById('caja10').classList.contains('bg-gray-700') &&-->
<!--        document.getElementById('caja11').classList.contains('bg-yellow-400') &&-->
...
const paint = (id) => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-blue-900') &&
        ...
        document.getElementById('caja14').classList.contains('bg-yellow-400') &&
        ...
        document.getElementById('caja17').classList.contains('bg-yellow-400') &&
        document.getElementById('caja18').classList.contains('bg-yellow-400')
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-900', 'bg-red-600', 'bg-pink-500', 'bg-yellow-400', 'bg-white');
                                    ...
                                    <div class="flex justify-center my-5">
                                        <div class="grid md:grid-cols-12">
                                            ...
                                            <div @click="paint('caja2')" id="caja2"
                                                 class="p-6 border-black border-2 bg-yellow-400 cursor-cell">
