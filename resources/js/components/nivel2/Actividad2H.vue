...
const paint = (id) => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-green-600') &&
        ...
        document.getElementById('caja17').classList.contains('bg-green-600') &&
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-600', 'bg-green-600', 'bg-yellow-400', 'bg-yellow-400', 'bg-white');
