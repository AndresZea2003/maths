...
let numMuestra1 = ref(triangulo.value)
let numMuestra2 = ref(triangulo.value)
let numMuestra3 = ref(triangulo.value)
let numMuestra4 = ref(triangulo.value)
let numMuestra5 = ref(triangulo.value)
let numMuestra6 = ref(triangulo.value)
let numMuestra7 = ref(triangulo.value)
let numMuestra8 = ref(triangulo.value)
let numMuestra9 = ref(triangulo.value)

let numMuestra10 = ref(triangulo.value)
let numMuestra11 = ref(triangulo.value)
let numMuestra12 = ref(triangulo.value)
let numMuestra13 = ref(triangulo.value)
let numMuestra14 = ref(triangulo.value)
let numMuestra15 = ref(triangulo.value)
let numMuestra16 = ref(triangulo.value)
let numMuestra17 = ref(triangulo.value)
let numMuestra18 = ref(triangulo.value)
                            ...
                            <div id="vista" class="flex justify-center mt-5 duration-300">
                                <div class="grid grid-cols-2">
                                    <div class="grid grid-cols-5 border-r-2 border-dashed border-black pr-2">
                                        ...
                                        <div class="grid grid-cols-1 gap-y-5 flex justify-end items-center">
                                            ...
                                            <div class="flex justify-center">
                                                <div class="grid grid-cols-3">
                                                    <div v-for="i in 9" :key="i" :id="`caja${i + 100}`"
                                                         :class="['px-4', 'py-2' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'bg-gray-300'
                                             ]">
                                                        <img :src="this['numMuestra' + i]">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-5 border-l-2 border-dashed border-black pl-2">
                                        <div>{{ null }}</div>
                                        <div class="flex justify-center col-span-4">
                                            <svg width="40" clip-rule="evenodd" fill-rule="evenodd"
                                                 stroke-linejoin="round"
                        ...
                        <div :class="`${selectFig3} mr-5 pb-5 duration-300 col-span-4`">
                            ...
                            <div id="actividad" class="flex justify-center mt-5">
                                <div class="flex-col">
                                    <div>
                                        <div class="grid grid-cols-3">
                                            <div @click="add('num1')" id="num1"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">

                                                <img :src="num1" width="50">
                                            ...
                                            <div @click="error('caja2')" id="caja2"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <img :src="circulo" width="50">
                                                <div v-if="color2Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num3')" id="num3"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <img :src="num3" width="50">
                                            ...
                                            <div @click="error('caja5')" id="caja5"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <img :src="cuadrado" width="50">
                                                <div v-if="color5Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num6')" id="num6"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <img :src="num6" width="50">
                                                <div v-if="color6Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num7')" id="num7"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <img :src="num7" width="50">
                                                <div v-if="color7Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num8')" id="num8"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <img :src="num8" width="50">
                                                <div v-if="color8Error === true" class="flex justify-center">
                                                    <span
                                                        class="text-xl font-bold animate-pulse text-center select-none">Error</span>
                                                </div>
                                            </div>
                                            <div @click="add('num9')" id="num9"
                                                 class="p-4 bg-gray-200 border-black border cursor-cell hover:bg-gray-400">
                                                <img :src="num9" width="50">
                            ...
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectItem('cuadrado')"
                                                ...
                                                <div class="bg-orange-400 border-black border-2 py-3 px-5 rounded-lg">
