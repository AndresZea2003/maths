...
function helpFigures() {
    ...
    document.getElementById('izq').classList.add('scale-150')
    document.getElementById('izq').classList.add('text-red-600')
    document.getElementById('bg1').classList.remove('bg-white')
    document.getElementById('bg1').classList.add('bg-red-400')

    setTimeout(function () {
        document.getElementById('izq').classList.remove('scale-150')
        document.getElementById('izq').classList.remove('text-red-600')
        document.getElementById('bg1').classList.remove('bg-red-400')
        document.getElementById('bg1').classList.add('bg-white')
        document.getElementById('der').classList.add('scale-150')
        document.getElementById('der').classList.add('text-blue-600')
        document.getElementById('bg2').classList.remove('bg-white')
        document.getElementById('bg2').classList.add('bg-blue-600')
    }, 2000);
    setTimeout(function () {
        document.getElementById('der').classList.remove('scale-150')
        document.getElementById('der').classList.remove('text-blue-600')
        document.getElementById('bg2').classList.add('bg-white')
        document.getElementById('bg2').classList.remove('bg-blue-600')
    }, 4000);
...
const paint = (id) => {
    ...
    if (id === 'caja1') {
        circle1.value = getValueForColor(color);
    }

    if (id === 'caja2') {
        circle2.value = getValueForColor(color);
    }

    function getValueForColor(color) {
        switch (color) {
            case 'red-600':
                return 2;
            case 'blue-600':
            ...
            case 'white':
                return 1;
            default:
                return 0; // Valor predeterminado si no se encuentra un color válido
        }
    }
    ...
    if (circle1.value === 2 && circle2.value === 3
    ) {
        win()
        let sound = new Audio();
...
const selectColor = (bg) => {
    ...
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-900', 'bg-pink-500', 'bg-blue-600', 'bg-red-600', 'bg-white');
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-violet-300 border-4 border-violet-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    <div id="fondoMati"
                         class="bg-violet-200 border-4 border-violet-600 rounded-md flex items-end justify-center">
                        <div class="">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-violet-600 rounded-md pb-5 px-5 md:col-span-4 grid md:grid-cols-3 flex">
                        ...
                        <div class="col-span-3 mt-5">
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                <div id="bg1" class="bg-white border-4 rounded-md border-teal-400 flex justify-center duration-300">
                                    <div class="flex justify-center items-center">
                                        <svg @click="paint('caja1')" v-if="circle1 === 1" width="150"
                                        ...
                                        <svg @click="paint('caja1')" v-if="circle1 === 2" width="150" fill="red"
                                             clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                             stroke-miterlimit="2" viewBox="0 0 24 24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="11.998" cy="11.998" fill-rule="nonzero" r="9.998"/>
                                        </svg>
                                        <svg @click="paint('caja1')" v-if="circle1 === 3" width="150" fill="blue"
                                             clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                             stroke-miterlimit="2" viewBox="0 0 24 24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="11.998" cy="11.998" fill-rule="nonzero" r="9.998"/>
                                ...
                                <div id="bg2" class="bg-white border-4 rounded-md border-teal-400 flex-col duration-300">
                                    <div class="flex justify-center items-center">
                                        <svg @click="paint('caja2')" v-if="circle2 === 1" width="150"
                                             clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                             stroke-miterlimit="2" viewBox="0 0 24 24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <svg @click="paint('caja2')" v-if="circle2 === 2" width="150" fill="red"
                                             clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                             stroke-miterlimit="2" viewBox="0 0 24 24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="11.998" cy="11.998" fill-rule="nonzero" r="9.998"/>
                                        </svg>
                                        <svg @click="paint('caja2')" v-if="circle2 === 3" width="150" fill="blue"
                                             clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                             stroke-miterlimit="2" viewBox="0 0 24 24"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="11.998" cy="11.998" fill-rule="nonzero" r="9.998"/>
                                ...
                                <div class="flex justify-center bg-teal-100 border-teal-400 border-2">
                                    <div id="izq" class="flex duration-300">
                                        <svg id="arrowIzq" width="40" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                    ...
                                    <span class="font-MPlus text-2xl py-5 duration-300">Izquierda</span>
                                    </div>
                                </div>
                                <div class="flex justify-center bg-teal-100 border-teal-400 border-2">
                                    <div id="der" class="flex duration-300">
                                        <span class="font-MPlus text-2xl py-5 duration-300">Derecha</span>
                                    <svg width="40" id="arrowDer" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round"
                                         stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div>
                        <div class="bg-violet-400 border-black border-4 px-5">
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectColor('red-600')"
                                        ...
                                        <svg class="hover:opacity-75" fill="red" xmlns="http://www.w3.org/2000/svg"
                                             width="60" height="60"
                                             viewBox="0 0 24 24">
                                            <path
