...
<!--                        <span> Escribe todas las maneras diferentes de ordenar horizontalmente los numeros 4, 5 y 6</span>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('5')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-blue-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">5</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
                                    ...
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        <div class="grid grid-cols-3 gap-y-5 gap-x-1">
                                            <div v-for="i in 9" :key="i + 100" :id="`caja${i + 100}`"
                                                 :class="['px-5', 'py-3', 'border-black', 'border-2', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'flex', 'justify-center', 'font-bold', 'text-2xl', 'bg-gray-200'
                                             ]">
                                                {{ null }}
                                            </div>
                                        </div>
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2">
                                            <button @click="selectItem('4')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">4</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('5')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">5</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('6')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">6</span>
                                                </div>
                                            </button>
