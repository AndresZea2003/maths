...
@section('main')
    ...
    <layout-sudoku
        ...
        icon_2="icon-yellow"
        icon_3="icon-red1"
        sound_item_1="{{asset('audio/voz1/animals/the/ElTiburon.m4a')}}"
        sound_item_2="{{asset('audio/voz1/animals/the/ElCangrejo.m4a')}}"
        sound_item_3="{{asset('audio/voz1/animals/the/ElPulpo.m4a')}}"
