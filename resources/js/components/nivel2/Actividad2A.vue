...
<!--        document.getElementById('caja5').classList.contains('bg-red-600') &&-->
<!--        document.getElementById('caja6').classList.contains('bg-green-600') &&-->
<!--        document.getElementById('caja7').classList.contains('bg-red-600') &&-->
<!--        document.getElementById('caja8').classList.contains('bg-green-600') &&-->
...
function initialAudio() {
    if (talk.value === false) {
        ...
        let sound = new Audio();
        sound.src = `${props.asset_audio}/voz1/nivel2/inicio1.m4a`;
        sound.play()
        setTimeout(function () {
            let sound = new Audio();
            sound.src = `${props.asset_audio}/voz1/observa.m4a`;
            sound.play()
        }, 6500)
        setTimeout(function () {
            let sound = new Audio();
        ...
        widthMati.value = 160;
        setTimeout(resetMati, 20500);
    }
}

function showIndexSquare() {
    setTimeout(function () {
        document.getElementById('marte').classList.add('scale-150')
    }, 1500)
    setTimeout(function () {
        document.getElementById('venus').classList.add('scale-150')
    }, 2200)
    setTimeout(function () {
        document.getElementById('marte').classList.remove('scale-150')
        document.getElementById('venus').classList.remove('scale-150')
    }, 4000)
    ...
    setTimeout(function (){
        document.getElementById('caja1').classList.remove('bg-white')
        document.getElementById('caja1').classList.add('bg-red-600')
    }, 8000)
    setTimeout(function () {
        document.getElementById('caja2').classList.remove('bg-white')
        document.getElementById('caja2').classList.add('bg-green-600')
    }, 9500)
    setTimeout(function () {
        document.getElementById('caja3').classList.remove('bg-white')
        document.getElementById('caja3').classList.add('bg-red-600')
    }, 11000)
    setTimeout(function () {
        document.getElementById('caja4').classList.remove('bg-white')
        document.getElementById('caja4').classList.add('bg-green-600')
    }, 12500)
    setTimeout(function () {
...
const paint = (id) => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-red-600') &&
        ...
        document.getElementById('caja11').classList.contains('bg-red-600') &&
        document.getElementById('caja12').classList.contains('bg-green-600') &&
        document.getElementById('caja13').classList.contains('bg-red-600') &&
        ...
        document.getElementById('caja17').classList.contains('bg-red-600') &&
                ...
                <div class="mx-5 grid md:grid-cols-6 gap-5">
                    <div id="fondoMati"
                        ...
                        <div class="">
                            ...
                            <img :src="mati" :width="widthMati" class="select-none"
                                 alt="">
                        </div>
                    </div>
                    ...
                    <div id="board"
                        ...
                        <div class="col-span-3">
                            <div class="flex justify-center mt-5 gap-5">
                                <div>
                                    <img id="marte" class="duration-300"
                                         :src="`${props.asset_images}/planetas/rojo.svg`" width="50" alt="">
                                </div>
                                ...
                                <div>
                                    <img id="venus" class="duration-300"
                                         :src="`${props.asset_images}/planetas/venus.svg`" width="55" alt="">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectColor('red-600')"
                                        ...
                                        <svg class="hover:opacity-50" fill="red" xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                             viewBox="0 0 24 24">
                                            <path
