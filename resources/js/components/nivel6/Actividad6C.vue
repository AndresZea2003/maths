...
const paint = (id) => {
    ...
    document.getElementById(id).classList.remove('bg-pink-400')
...
const selectColor = (bg) => {
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-gray-700', 'bg-red-600', 'bg-green-600', 'bg-yellow-400', 'bg-white', 'bg-pink-400');
                            ...
                            <div id="vista" class="flex justify-center duration-300">
                                <div class="flex-col grid gap-5">
                                    <div class="grid grid-cols-7 mt-5">
                                        <div v-for="i in 49" :key="i" :id="`muestra${i}`"
                                             :class="['p-5' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none',
                                                     { 'bg-gray-700' : i === 1 || i === 2 || i === 3 || i === 4|| i === 5|| i === 6 || i === 7 || i === 8 || i === 14 || i === 15 || i === 21 ||
                                                     i === 22 || i === 28 || i === 29 || i === 36 || i === 43 || i === 44 || i === 45 || i === 46 || i === 35 || i === 47 || i === 48 || i === 49 || i === 42 },
                                                     { 'bg-yellow-400' : i === 9 || i === 10|| i === 11|| i === 12|| i === 13 || i === 16 || i === 20 || i === 23 || i === 30 || i === 37 ||
                                                     i === 38 || i === 39 || i === 40 || i === 41 || i === 27 || i === 34 },
                                                     { 'bg-green-600' : i === 17|| i === 18 || i === 19 || i === 24 || i === 26 || i === 31 || i === 32 || i === 33 },
                                                     { 'bg-pink-400': i === 25}
                        ...
                        <div :class="`${selectFig3} mr-5 pb-5 duration-300`">
                            ...
                            <div id="actividad" class="flex justify-center">
                                <div class="flex-col">
                                    <div>
                                        <div class="grid grid-cols-7 mt-5">
                                            <div v-for="i in 49" :key="i" :id="`caja${i}`"
                                             @click="paint(`caja${i}`)"
                                             :class="['p-5' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none'
                                             ]">
                                            {{ null }}
                    ...
                    <div>
                        <div class="bg-blue-300 border-black border-4 px-5">
                            <div class="grid grid-cols-2 gap-5 flex">
                                ...
                                <div class="flex justify-center">
                                    <button @click="selectColor('pink-400')"
                                            class="rounded-md p-2 shadow-md bg-gray-300">
