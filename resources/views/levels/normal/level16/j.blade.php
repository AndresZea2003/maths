...
<layout-sudoku
        ...
        item_1="{{ asset('images/frutas/uvas.svg') }}"
        item_2="{{ asset('images/frutas/banananew.svg') }}"
        item_3="{{ asset('images/frutas/fresa.svg') }}"
        color_1=""
        color_2=""
        color_3=""
        icon_1="icon-blue"
        icon_2="icon-yellow"
        icon_3="icon-red1"
        sound_item_1="{{asset('audio/voz1/frutas/the/LasUvas.m4a')}}"
        sound_item_2="{{asset('audio/voz1/frutas/the/LasBananas.m4a')}}"
        sound_item_3="{{asset('audio/voz1/frutas/the/LasFresas.m4a')}}"
        ...
        introduction_audio_2="{{asset('audio/voz1/sudokus/inicios/ubicafruta.m4a')}}"
        caja_1=""
        caja_2="1"
        caja_3="2"
        caja_4="1"
