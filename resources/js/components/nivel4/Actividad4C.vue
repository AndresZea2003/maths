...
const check = () => {
    ...
    if (document.getElementById('caja1').classList.contains('bg-check') &&
        ...
        document.getElementById('caja154').classList.contains(colorA) &&
        document.getElementById('caja155').classList.contains(colorA) &&
        document.getElementById('caja156').classList.contains(colorA) &&
        document.getElementById('caja157').classList.contains(colorA) &&
        document.getElementById('caja158').classList.contains(colorA) &&
        document.getElementById('caja159').classList.contains(colorA) &&
        document.getElementById('caja160').classList.contains(colorA) &&
        document.getElementById('caja161').classList.contains(colorA) &&
        document.getElementById('caja162').classList.contains(colorA) &&
        ...
        document.getElementById('caja280').classList.contains(colorC) &&
        document.getElementById('caja281').classList.contains(colorC) &&
        document.getElementById('caja282').classList.contains(colorC) &&
        document.getElementById('caja283').classList.contains(colorC) &&
        document.getElementById('caja284').classList.contains(colorC) &&
        document.getElementById('caja285').classList.contains(colorC) &&
        document.getElementById('caja286').classList.contains(colorC) &&
        document.getElementById('caja287').classList.contains(colorC) &&
        document.getElementById('caja288').classList.contains(colorC) &&
