                            ...
                            <div id="actividad" class="border-gray-400 border-4 flex items-center justify-center pr-1">
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-10 gap-x-2">
                                        ...
                                        <div @click="error('caja65')" id="caja65"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja69')" id="caja69"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja75')" id="caja75"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja79')" id="caja79"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja85')" id="caja85"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja89')" id="caja89"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja95')" id="caja95"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
                                        ...
                                        <div @click="error('caja99')" id="caja99"
                                             class="p-5 bg-red-500 border-black border cursor-cell hover:bg-gray-400">
                                            {{ null }}
                                        </div>
