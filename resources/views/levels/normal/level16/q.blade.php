...
<layout-sudoku
        ...
        icon_2="icon-yellow"
        icon_3="icon-red1"
        sound_item_1="{{asset('audio/voz1/letters/D.m4a')}}"
        sound_item_2="{{asset('audio/voz1/letters/E.m4a')}}"
        sound_item_3="{{asset('audio/voz1/letters/F.m4a')}}"
        ...
        :sudoku_size="{{ 3 }}"
        introduction_audio_1="{{asset('audio/voz1/sudokus/inicios/vamosletras.m4a')}}"
        introduction_audio_2="{{asset('audio/voz1/sudokus/inicios/ubicaletra.m4a')}}"
        caja_1="2"
        caja_2="3"
        caja_3=""
        caja_4=""
