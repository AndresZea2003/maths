...
<!--                        <span> Escribe todas las maneras diferentes de ordenar horizontalmente el Cuadrado, Triangulo y Circulo</span>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                                    <button @click="selectItem('cuadrado')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-orange-300 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <img :src="cuadrado" width="50" alt="">-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('triangulo')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-orange-300 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <img :src="triangulo" width="50" alt="">-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('circulo')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-orange-300 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <img :src="circulo" width="50" alt="">-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem(null)" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-orange-300 border-black border-4 py-9 px-11 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl"></span>-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                </div>-->
...
<!--                                            <button @click="add('num1')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num1">-->
<!--                                                <img :src="num1">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num2')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num2">-->
<!--                                                <img :src="num2">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num3')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num3">-->
<!--                                                <img :src="num3">-->
<!--                                            </button>-->
<!--                                        </div>-->
...
<!--                                        <div class="grid grid-cols-3">-->
<!--                                            <button @click="add('num4')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num4">-->
<!--                                                <img :src="num4">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num5')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num5">-->
<!--                                                <img :src="num5">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num6')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num6">-->
<!--                                                <img :src="num6">-->
<!--                                            </button>-->
<!--                                        </div>-->
...
<!--                                        <div class="grid grid-cols-3">-->
<!--                                            <button @click="add('num7')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num7">-->
<!--                                                <img :src="num7">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num8')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num8">-->
<!--                                                <img :src="num8">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num9')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num9">-->
<!--                                                <img :src="num9">-->
<!--                                            </button>-->
<!--                                        </div>-->
...
<!--                                        <div class="grid grid-cols-3">-->
<!--                                            <button @click="add('num10')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num10">-->
<!--                                                <img :src="num10">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num11')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num11">-->
<!--                                                <img :src="num11">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num12')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num12">-->
<!--                                                <img :src="num12">-->
<!--                                            </button>-->
<!--                                        </div>-->
...
<!--                                        <div class="grid grid-cols-3">-->
<!--                                            <button @click="add('num13')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num13">-->
<!--                                                <img :src="num13">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num14')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num14">-->
<!--                                                <img :src="num14">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num15')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num15">-->
<!--                                                <img :src="num15">-->
<!--                                            </button>-->
<!--                                        </div>-->
...
<!--                                        <div class="grid grid-cols-3">-->
<!--                                            <button @click="add('num16')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num16">-->
<!--                                                <img :src="num16">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num17')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num17">-->
<!--                                                <img :src="num17">-->
<!--                                            </button>-->
<!--                                            <button @click="add('num18')" class="bg-red-400 border-black border-4 flex justify-center items-center p-7"-->
<!--                                                    id="num18">-->
<!--                                                <img :src="num18">-->
<!--                                            </button>-->
<!--                                        </div>-->
...
const selectColor = (bg) => {
    color = bg
    colorSelected.value++
    document.getElementById('muestra').classList.remove('bg-blue-600', 'bg-fuchsia-400', 'bg-yellow-400', 'bg-white', 'bg-red-600', 'bg-green-600');
...
const win = () => {
    ...
    setTimeout(() => {
        ...
        document.getElementById('fondoMati').classList.add('bg-red-200');
        ...
        document.getElementById('board').classList.add('to-red-200')
...
onMounted(() => {
    document.getElementById('caja101').innerHTML = 'X'
    document.getElementById('caja102').innerHTML = 'X'
    document.getElementById('caja103').innerHTML = 'X'
    document.getElementById('caja104').innerHTML = 'X'
    document.getElementById('caja105').innerHTML = 'X'
    document.getElementById('caja106').innerHTML = 'X'
    document.getElementById('caja107').innerHTML = 'X'
    document.getElementById('caja108').innerHTML = 'X'
    document.getElementById('caja109').innerHTML = 'X'
    document.getElementById('caja110').innerHTML = 'X'
    document.getElementById('caja111').innerHTML = 'X'
    document.getElementById('caja112').innerHTML = 'X'
    document.getElementById('caja113').innerHTML = 'X'
    document.getElementById('caja114').innerHTML = 'X'
    document.getElementById('caja115').innerHTML = 'X'
    document.getElementById('caja116').innerHTML = 'X'
    document.getElementById('caja117').innerHTML = 'X'
    document.getElementById('caja118').innerHTML = 'X'
});
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-orange-300 border-4 border-orange-400 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-12 gap-5">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-orange-600 rounded-md pr-5 md:col-span-10 grid md:grid-cols-11 flex items-center">
                                    ...
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        <div class="grid grid-cols-3 gap-y-5 gap-x-1">
                                            <div v-for="i in 9" :key="i + 100" :id="`caja${i + 100}`"
                                                 :class="['px-5', 'py-3', 'border-black', 'border-2', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'flex', 'justify-center', 'font-bold', 'text-xl'
                                             ]">
                                                {{ null }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2 opacity-50">
                                            <button class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">X</span>
                                                </div>
                                            </button>
                                            <button class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                            ...
                                            <button @click="selectItem(null)"
                                                    class="relative rounded-md py-1 px-2 shadow-md bg-gray-300  flex justify-center select-none">
                                                <div class="relative">
                        ...
                        <div class="flex justify-center h-full pt-16">
                            ...
                            <div v-if="winLevel === true" class="">
                                ...
                                <span
                                    class="font-MPlus text-2xl bg-red-400 p-2 rounded-lg border-4 border-red-500 animate-pulse">Felicidades!</span>
                            ...
                            <svg v-else fill="#9ca3af" id="arrow"
                                 :class="`${selectFig2} flex justify-center h-full pt-16`"
                                 clip-rule="evenodd" fill-rule="evenodd" width="80"
                                    ...
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        <div class="grid grid-cols-3">
                                            <button @click="add('num1')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num1">
                                                <img :src="num1">
                                            </button>
                                        ...
                                        <div class="grid grid-cols-3 mt-4">
                                            <button @click="add('num10')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num10">
                                                <img :src="num10">
                                            </button>
                                            <button @click="add('num11')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num11">
                                                <img :src="num11">
                                            </button>
                                            <button @click="add('num12')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num12">
                                                <img :src="num12">
                                            </button>
                                        ...
                                        <div class="grid grid-cols-3 mt-4">
                                            <button @click="add('num13')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num13">
                                                <img :src="num13">
                                            </button>
                                            <button @click="add('num14')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num14">
                                                <img :src="num14">
                                            </button>
                                            <button @click="add('num15')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num15">
                                                <img :src="num15">
                                            </button>
                                        ...
                                        <div class="grid grid-cols-3 mt-4">
                                            <button @click="add('num16')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num16">
                                                <img :src="num16">
                                            </button>
                                            <button @click="add('num17')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num17">
                                                <img :src="num17">
                                            </button>
                                            <button @click="add('num18')"
                                                    class="border-black border-2 flex justify-center items-center p-7"
                                                    id="num18">
                                                <img :src="num18">
                                            </button>
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2">
                                            <button @click="selectItem('cuadrado')"
                                                ...
                                                <div class="bg-orange-300 border-black border-2 py-3 px-5 rounded-lg">
                                        ...
                                        <div v-if="content === null" id="muestra"
                                             class="border-2 border-black py-6 mx-20 mt-5 bg-white col-span-2 shadow-2xl shadow-blue-900 flex justify-center font-bold text-5xl">
                                            {{ content }}
                                        </div>
                                        <div v-else id="muestra"
                                             class="border-2 border-black py-1 mx-20 mt-5 bg-white col-span-2 shadow-2xl shadow-blue-900 flex justify-center font-bold text-5xl">
                                            <img :src="`${props.asset_images}/cosas/${content}.svg`" width="40">
                                        </div>
                                    </div>
                                </div>
                            </div>
