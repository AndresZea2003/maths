...
<layout-sudoku
        ...
        audio_win="{{asset('audio/voz1/win/excelentenext.m4a')}}"
        ...
        :sudoku_size="{{ 3 }}"
        :introduction="true"
        introduction_audio_1="{{asset('audio/voz1/sudokus/inicios/inicioAnimales1.m4a')}}"
        ...
        ok_audio_2="{{asset('audio/voz1/sudokus/animals/nicecocodrilo.m4a')}}"
        ok_audio_3=""
        ok_audio_4=""
        ok_audio_1.2=""
        ok_audio_2.2=""
