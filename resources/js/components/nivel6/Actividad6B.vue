                            ...
                            <div id="vista" class="flex justify-center mt-5 duration-300">
                                <div class="flex-col grid gap-5">
                                    <div class="grid grid-cols-7 mt-5">
                                        <div v-for="i in 35" :key="i" :id="`muestra${i}`"
                                             :class="['p-5' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none',
                                                     { 'bg-blue-600' : i === 1 || i === 2 || i === 3 || i === 4|| i === 5|| i === 6 || i === 7 || i === 8 || i === 14 || i === 15 || i === 21 ||
                                                     i === 22 || i === 28 || i === 29 || i === 30 || i === 31 || i === 32 || i === 33 || i === 34 || i === 35  },
                                                     { 'bg-red-600' : i === 9 || i === 10|| i === 11|| i === 12|| i === 13 || i === 16 || i === 20 || i === 23 || i === 24 || i === 25 ||
                                                     i === 26 || i === 27 },
                                                     { 'bg-yellow-400' : i === 17|| i === 18 || i === 19}
                        ...
                        <div :class="`${selectFig3} mr-5 pb-5 duration-300`">
                            ...
                            <div id="actividad" class="flex justify-center mt-5">
                                <div class="flex-col">
                                    <div>
                                        <div class="grid grid-cols-7 mt-5">
                                            <div v-for="i in 35" :key="i" :id="`caja${i}`"
                                             @click="paint(`caja${i}`)"
                                             :class="['p-5' , 'border-black', 'border', 'cursor-cell', 'grid', 'hover:bg-gray-400', 'duration-300', 'select-none'
                                             ]">
                                            {{ null }}
