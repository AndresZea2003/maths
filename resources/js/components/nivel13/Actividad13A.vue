...
<!--            <div class="bg-green-100 border-4 border-stone-600 flex-col pb-2 rounded-md shadow-2xl">-->
<!--                <div class="mx-5 py-2">-->
<!--                    <div>-->
<!--                        <span class="font-bold">Actividad 1 -</span>-->
<!--                        <span> Escribe todas las maneras diferentes de ordenar horizontalmente las letras X, Y y Z</span>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                                    <button @click="selectItem('X')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-green-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">X</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('Y')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-green-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">Y</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
<!--                                    <button @click="selectItem('Z')" class="flex justify-center items-center ">-->
<!--                                        <div class="bg-green-400 border-black border-4 py-3 px-5 rounded-lg">-->
<!--                                            <span class="font-MPlus text-5xl">Z</span>-->
<!--                                        </div>-->
<!--                                    </button>-->
...
<!--                            </div>-->
<!--                        </div>-->
<!--                        &lt;!&ndash;                        <div class="bg-rose-300 border-black border-4">&ndash;&gt;-->
<!--                        &lt;!&ndash;                            <div class="grid grid-cols-2 gap-5 flex">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                <div class="bg-gray-900 col-span-2 border-4 border-stone-400 flex justify-center py-12">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    <div class="text-rose-300 font-bold text-2xl">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                        Planeta Rosa&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    </div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                </div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                <div class="col-span-2 mx-1 flex justify-center">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    <div class="bg-green-200 rounded-md px-2 flex">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                        <ArrowDownIcon class="w-5"/>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                        <div class="font-bold">PALETA DE COLORES</div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                        <ArrowDownIcon class="w-5"/>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    </div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                </div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                <div class="flex justify-center">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    <button @click="selectColor('yellow-400')"&ndash;&gt;-->
<!--                        &lt;!&ndash;                                            class="border-2 border-black bg-yellow-400 hover:bg-yellow-500 rounded-full p-5">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                        {{ null }}&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    </button>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                </div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                <div class="flex justify-center">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    <button @click="selectColor('white')"&ndash;&gt;-->
<!--                        &lt;!&ndash;                                            class="border-2 border-black bg-white hover:bg-gray-200 rounded-full p-5">&ndash;&gt;-->
<!--                        &lt;!&ndash;                                        {{ null }}&ndash;&gt;-->
<!--                        &lt;!&ndash;                                    </button>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                </div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                                <div id="muestra" class="border-2 border-black p-10 m-2 bg-white col-span-2"></div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                            </div>&ndash;&gt;-->
<!--                        &lt;!&ndash;                        </div>&ndash;&gt;-->
<!--                    </div>-->
<!--                </div>-->
...
onMounted(() => {
    document.getElementById('caja101').innerHTML = 'A'
    document.getElementById('caja102').innerHTML = 'B'
    document.getElementById('caja103').innerHTML = 'C'
    document.getElementById('caja104').innerHTML = 'A'
    document.getElementById('caja105').innerHTML = 'C'
    document.getElementById('caja106').innerHTML = 'B'
    document.getElementById('caja107').innerHTML = 'B'
    document.getElementById('caja108').innerHTML = 'A'
    document.getElementById('caja109').innerHTML = 'C'
    document.getElementById('caja110').innerHTML = 'B'
    document.getElementById('caja111').innerHTML = 'C'
    document.getElementById('caja112').innerHTML = 'A'
    document.getElementById('caja113').innerHTML = 'C'
    document.getElementById('caja114').innerHTML = 'A'
    document.getElementById('caja115').innerHTML = 'B'
    document.getElementById('caja116').innerHTML = 'C'
    document.getElementById('caja117').innerHTML = 'B'
    document.getElementById('caja118').innerHTML = 'A'
});
        ...
        <div class="container mx-auto mb-10 rounded-md px-5 mt-5">
            <div class="bg-green-400 border-4 border-green-600 flex-col pb-2 rounded-md shadow-2xl">
                ...
                <div class="mx-5 grid md:grid-cols-12 gap-5">
                    <div id="fondoMati"
                         class="bg-orange-200 border-4 border-green-600 rounded-md flex items-end justify-center col-span-2">
                        <div class="">
                    ...
                    <div id="board"
                         class="bg-white border-4 border-green-600 rounded-md pr-5 md:col-span-10 grid md:grid-cols-11 flex items-center">
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2 opacity-50">
                                            <button @click="selectItem('A')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">A</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('B')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">B</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('C')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">C</span>
                                                </div>
                                            </button>
                                ...
                                <div class="flex justify-center">
                                    <div class="grid md:grid-cols-2 gap-x-10">
                                        ...
                                        <div class="mt-5 flex justify-center gap-5 col-span-2">
                                            ...
                                            <button @click="selectItem('Y')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">Y</span>
                                                </div>
                                            </button>
                                            <button @click="selectItem('Z')" class="flex justify-center items-center ">
                                                <div class="bg-blue-400 border-black border-2 py-3 px-5 rounded-lg">
                                                    <span class="font-MPlus text-2xl">Z</span>
                                                </div>
                                            </button>
                                        ...
                                        <div v-if="content === null" id="muestra"
                                             class="border-2 border-black py-6 mx-20 mt-5 bg-white col-span-2 shadow-2xl shadow-blue-900 flex justify-center font-bold text-5xl">{{ content }}</div>
                                        <div v-else id="muestra"
                                             class="border-2 border-black mx-20 mt-5 bg-white col-span-2 shadow-2xl shadow-blue-900 flex justify-center font-bold text-5xl">{{ content }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
